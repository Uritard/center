...
public class RunningThread {
    ...
    static class InternalRunner implements Runnable {
            ...
            try {
                ...
                for (Map<String, Object> device : onlinePatrolDevice) {
                    ...
                    if ("robot".equals(device.get("type"))) {
                        ...
                        Map<String, Object> map11 = createMap(device, 11, mapForChargeCurrent);
                        list.add(map11);
                    }
        ...
        private void sendStatus(Map<String, Object> device) {
            ...
            XMLBaseModel xmlBaseModel = new XMLBaseModel().setType("1").setCode(Constant.stationCode()).setItems(list);
        ...
        private void addStateMap(List<Map<String, Object>> list, Map<String, Object> device, int type, String valueDef) {
            ...
            Map<String, Object> mapUp = createMap(device, type, stateMap);
            list.add(mapUp);
        }

        public Map<String, Object> createMap(Map<String, Object> device, Integer type, Map<String, Object> mapForRedis) {
            Map<String, Object> map = new HashMap<>(16);
            String patroldeviceName =
                StringUtils.isNotEmpty(MapUtils.getString(device, "robot_name")) ? MapUtils.getString(device, "robot_name") :
                    MapUtils.getString(mapForRedis, "patrolDeviceName", "");
            String patrolDeviceCode =
                StringUtils.isNotEmpty(MapUtils.getString(device, "robot_num")) ? MapUtils.getString(device, "robot_num") :
                    MapUtils.getString(mapForRedis, "patrolDeviceCode", "");
