package com.yjh.accesstcp.datasource;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.yjh.accesstcp.module.*.dao"}, sqlSessionTemplateRef = "baseSqlSessionTemplate")
public class ManageDataSourceConfig {
    ...
    @Value("${spring.datasource.accesstcp.password}")
    private String password;

    @Bean(name = "baseDataSource")
    @ConfigurationProperties(prefix = "spring.datasource.accesstcp")
