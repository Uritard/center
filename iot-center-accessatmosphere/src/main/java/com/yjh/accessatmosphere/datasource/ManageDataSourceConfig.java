package com.yjh.accessatmosphere.datasource;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.yjh.accessatmosphere.module.*.dao"}, sqlSessionTemplateRef = "baseSqlSessionTemplate")
public class ManageDataSourceConfig {

    private Logger log = LoggerFactory.getLogger(ManageDataSourceConfig.class);

    @Value("${spring.datasource.accessatmosphere.publicKey}")
    private String publicKey;

    @Value("${spring.datasource.accessatmosphere.password}")
    private String password;

    @Bean(name = "baseDataSource")
    @ConfigurationProperties(prefix = "spring.datasource.accessatmosphere")
