...
package com.yjh.manager.module.gateway.controller;

import com.yjh.manager.common.Constant;
import com.yjh.manager.common.authFilter.zuulFilter;
...
import com.yjh.manager.module.gateway.service.RefreshRouteService;
...
public class RouteController {
    ...
    public Result routeList() {
        Result result = new Result();
        try {
            result.setData(refreshRouteService.routeList());
        } catch (Exception e) {
            result.setCode(ResultCodeEnum.SYSTEMERROR.getCode(), "内部错误");
            log.error("login", e);
        }
