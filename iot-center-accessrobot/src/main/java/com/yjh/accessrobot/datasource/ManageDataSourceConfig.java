package com.yjh.accessrobot.datasource;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.yjh.accessrobot.module.*.dao"}, sqlSessionTemplateRef = "baseSqlSessionTemplate")
public class ManageDataSourceConfig {

    private Logger log = LoggerFactory.getLogger(ManageDataSourceConfig.class);

    @Value("${spring.datasource.accessrobot.publicKey}")
    private String publicKey;

    @Value("${spring.datasource.accessrobot.password}")
    private String password;

    @Bean(name = "baseDataSource")
    @ConfigurationProperties(prefix = "spring.datasource.accessrobot")
