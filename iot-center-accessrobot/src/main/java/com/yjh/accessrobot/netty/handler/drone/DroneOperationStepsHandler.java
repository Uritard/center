...
@Slf4j
@Service
public class DroneOperationStepsHandler implements DroneMessageHandlerStrategy, InitializingBean {
    ...
    public void handler(ChannelHandlerContext ctx, RobotServerHandler droneServerHandler, XMLBaseModel xmlBaseModel, long sendSessionId, long receiveSessionId) throws Exception {
        log.info("巡视主机收到无人机步骤消息了");
        String droneCode = xmlBaseModel.getSendCode();
        droneService.updateOperationStepsForRedis(xmlBaseModel);
    ...
    public void afterPropertiesSet() throws Exception {
        DroneMessageHandlerStrategyFactory.register(DroneHandlerEnum.OPERATION_STEPS.getCode(), this);
    }
}
