...
import com.yjh.accessrobot.module.command.entity.TRobotInspectionAttr;
import com.yjh.accessrobot.module.command.service.TRobotInspectionAttrService;
 ...
 **/
@RestController
@RequestMapping("/t-robot-inspection-attr/v1")
@Api(value = "/t-robot-inspection-attr", tags = "机器人巡检点属性表操作接口")
@Slf4j
