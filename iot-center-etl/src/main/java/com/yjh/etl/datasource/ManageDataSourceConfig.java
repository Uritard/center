 ...
 */
@Configuration
@MapperScan(basePackages = {"com.yjh.etl.module.*.dao"}, sqlSessionTemplateRef = "baseSqlSessionTemplate")
public class ManageDataSourceConfig {

    private Logger log = LoggerFactory.getLogger(ManageDataSourceConfig.class);

    @Value("${spring.datasource.etl.publicKey}")
    private String publicKey;

    @Value("${spring.datasource.etl.password}")
