package com.yjh.accessvideo.datasource;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.yjh.accessvideo.module.*.dao"}, sqlSessionTemplateRef = "baseSqlSessionTemplate")
public class ManageDataSourceConfig {

    private Logger log = LoggerFactory.getLogger(ManageDataSourceConfig.class);

    @Value("${spring.datasource.accessvideo.publicKey}")
    private String publicKey;

    @Value("${spring.datasource.accessvideo.password}")
    private String password;

    @Bean(name = "baseDataSource")
    @ConfigurationProperties(prefix = "spring.datasource.accessvideo")
