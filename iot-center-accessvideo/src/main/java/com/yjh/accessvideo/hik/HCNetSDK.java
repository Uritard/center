...
public interface HCNetSDK extends Library {
    ...
    /////////////////////////////////////////////////////////////////////////
    //校时结构参数
    public static class NET_DVR_TIME extends StructureFieldOrder {//校时结构参数
        public int dwYear;        //年
    ...
    public static class NET_DVR_SCHEDTIME extends StructureFieldOrder {
    ...
    public static class NET_DVR_HANDLEEXCEPTION_V30 extends StructureFieldOrder {
    ...
    //报警和异常处理结构(子结构)(多处使用)
    public static class NET_DVR_HANDLEEXCEPTION extends StructureFieldOrder {
        public int dwHandleType;			/*处理方式,处理方式的"或"结果*//*0x00: 无响应*//*0x01: 监视器上警告*//*0x02: 声音警告*//*0x04: 上传中心*/	/*0x08: 触发报警输出*//*0x20: 触发抓图*/  //(JPEG定制)
    ...
    //DVR设备参数
    public static class NET_DVR_DEVICECFG extends StructureFieldOrder {
        public int dwSize;
    ...
    //DVR设备参数
    public static class NET_DVR_DEVICECFG_V40 extends StructureFieldOrder {
        public int dwSize;
        public byte[] sDVRName = new byte[NAME_LEN];     //DVR名称
        public int dwDVRID;                //DVR ID,用于遥控器 //V1.4(0-99), V1.5(0-255)
        public int dwRecycleRecord;        //是否循环录像,0:不是; 1:是
    ...
    public static class NET_DVR_IPADDR extends StructureFieldOrder {
    ...
    //网络数据结构(子结构)(9000扩展)
    public static class NET_DVR_ETHERNET_V30 extends StructureFieldOrder {
    ...
    public static class NET_DVR_ETHERNET extends StructureFieldOrder {//网络数据结构(子结构)
    ...
    public static class NET_DVR_PPPOECFG extends StructureFieldOrder {//PPPoe
        public int dwPPPoE;
    ...
    public static class NET_DVR_NETCFG_V30 extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_NETCFG extends StructureFieldOrder {//网络配置结构
        public int dwSize;
    ...
    //通道图象结构
    public static class NET_DVR_SCHEDTIMEWEEK extends StructureFieldOrder {
        public NET_DVR_SCHEDTIME[] struAlarmTime = new NET_DVR_SCHEDTIME[8];


    }

    public static class byte96 extends StructureFieldOrder {
        public byte[] byMotionScope = new byte[96];


    }

    public static class NET_DVR_MOTION_V30 extends StructureFieldOrder {//移动侦测(子结构)(9000扩展)
    ...
    public static class NET_DVR_MOTION extends StructureFieldOrder {//移动侦测(子结构)
    ...
    public static class NET_DVR_HIDEALARM_V30 extends StructureFieldOrder {//遮挡报警
    ...
    public static class NET_DVR_HIDEALARM extends StructureFieldOrder {//遮挡报警(子结构)  区域大小704*576
        public int dwEnableHideAlarm;				/* 是否启动遮挡报警 ,0-否,1-低灵敏度 2-中灵敏度 3-高灵敏度*/
        public short wHideAlarmAreaTopLeftX;			/* 遮挡区域的x坐标 */
        public short wHideAlarmAreaTopLeftY;			/* 遮挡区域的y坐标 */
        public short wHideAlarmAreaWidth;				/* 遮挡区域的宽 */
    ...
    public static class NET_DVR_VILOST_V30 extends StructureFieldOrder {    //信号丢失报警(子结构)(9000扩展)
    ...
    public static class NET_DVR_VILOST extends StructureFieldOrder {    //信号丢失报警(子结构)
        public byte byEnableHandleVILost;	/* 是否处理信号丢失报警 */
        public NET_DVR_HANDLEEXCEPTION strVILostHandleType;	/* 处理方式 */

    }

    public static class NET_DVR_SHELTER extends StructureFieldOrder {  //遮挡区域(子结构)
    ...
    public static class NET_DVR_COLOR extends StructureFieldOrder {
    ...
    public static class NET_DVR_VICOLOR extends StructureFieldOrder {
    ...
    //信号丢失
    public static class NET_DVR_VILOST_V40 extends StructureFieldOrder {
    ...
    public static class NET_DVR_DNMODE extends StructureFieldOrder {
    ...
    public static class NET_DVR_MOTION_MULTI_AREAPARAM extends StructureFieldOrder {
    ...
    public static class NET_DVR_MOTION_MULTI_AREA extends StructureFieldOrder {
    ...
    public static class NET_DVR_MOTION_SINGLE_AREA extends StructureFieldOrder {
    ...
    public static class NET_DVR_MOTION_MODE_PARAM extends StructureFieldOrder {
    ...
    public static class NET_DVR_MOTION_V40 extends StructureFieldOrder {
    ...
    public static class NET_DVR_RGB_COLOR extends StructureFieldOrder {
    ...
    public static class NET_DVR_HIDEALARM_V40 extends StructureFieldOrder {
        public int dwEnableHideAlarm;                /* 是否启动遮挡报警，0-否，1-低灵敏度，2-中灵敏度，3-高灵敏度*/
        public short wHideAlarmAreaTopLeftX;            /* 遮挡区域的x坐标 */
        public short wHideAlarmAreaTopLeftY;            /* 遮挡区域的y坐标 */
        public short wHideAlarmAreaWidth;                /* 遮挡区域的宽 */
    ...
    public static class NET_DVR_PICCFG_V40 extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_PICCFG_V30 extends StructureFieldOrder {
        public int dwSize;
        public byte[] sChanName = new byte[NAME_LEN];
        public int dwVideoFormat;	            /* 只读 视频制式 1-NTSC 2-PAL*/
    ...
    public static class NET_DVR_PICCFG_EX extends StructureFieldOrder {//通道图象结构SDK_V14扩展
        public int dwSize;
        public byte[] sChanName = new byte[NAME_LEN];
        public int dwVideoFormat;	/* 只读 视频制式 1-NTSC 2-PAL*/
        public byte byBrightness;  	/*亮度,0-255*/
    ...
    public static class NET_DVR_PICCFG extends StructureFieldOrder { //通道图象结构(SDK_V13及之前版本)
        public int dwSize;
        public byte[] sChanName = new byte[NAME_LEN];
        public int dwVideoFormat;	/* 只读 视频制式 1-NTSC 2-PAL*/
        public byte byBrightness;  	/*亮度,0-255*/
    ...
    public static class NET_DVR_MULTI_STREAM_COMPRESSIONCFG_COND extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_MULTI_STREAM_COMPRESSIONCFG extends StructureFieldOrder {
        public int dwSize;
        public int dwStreamType;
    ...
    //码流压缩参数(子结构)(9000扩展)
    public static class NET_DVR_COMPRESSION_INFO_V30 extends StructureFieldOrder {
    ...
    //通道压缩参数(9000扩展)
    public static class NET_DVR_COMPRESSIONCFG_V30 extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_COMPRESSION_INFO extends StructureFieldOrder {//码流压缩参数(子结构)
    ...
    public static class NET_DVR_COMPRESSIONCFG extends StructureFieldOrder {//通道压缩参数
        public int dwSize;
    ...
    public static class NET_DVR_COMPRESSION_INFO_EX extends StructureFieldOrder {//码流压缩参数(子结构)(扩展) 增加I帧间隔
    ...
    public static class NET_DVR_RECORDSCHED extends StructureFieldOrder //时间段录像参数配置(子结构)
    {
    ...
    public static class NET_DVR_RECORDDAY extends StructureFieldOrder //全天录像参数配置(子结构)
    {
    ...
    public static class NET_DVR_RECORDSCHEDWEEK extends StructureFieldOrder {
        public NET_DVR_RECORDSCHED[] struRecordSched = new NET_DVR_RECORDSCHED[MAX_TIMESEGMENT_V30];


    }

    public static class NET_DVR_RECORD_V30 extends StructureFieldOrder {    //通道录像参数配置(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_RECORD extends StructureFieldOrder { //通道录像参数配置
        public int dwSize;
        public int dwRecord;  /*是否录像 0-否 1-是*/
        public NET_DVR_RECORDDAY[] struRecAllDay = new NET_DVR_RECORDDAY[MAX_DAYS];
        public NET_DVR_RECORDSCHEDWEEK[] struRecordSched = new NET_DVR_RECORDSCHEDWEEK[MAX_DAYS];
    ...
    public static class NET_DVR_STATFRAME extends StructureFieldOrder { //单帧统计参数
    ...
    public static class NET_DVR_STATTIME extends StructureFieldOrder { //单帧统计参数
    ...
    public static class NET_DVR_PDC_ALRAM_INFO extends StructureFieldOrder { //通道录像参数配置
        public int dwSize;
    ...
    //云台协议表结构配置
    public static class NET_DVR_PTZ_PROTOCOL extends StructureFieldOrder {
    ...
    public static class NET_DVR_PTZCFG extends StructureFieldOrder {
        public int dwSize;
     ...
     * 云台类型(end)
     ******************************/
    public static class NET_DVR_DECODERCFG_V30 extends StructureFieldOrder {//通道解码器(云台)参数配置(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_DECODERCFG extends StructureFieldOrder {//通道解码器(云台)参数配置
        public int dwSize;
        public int dwBaudRate;       //波特率(bps)，0－50，1－75，2－110，3－150，4－300，5－600，6－1200，7－2400，8－4800，9－9600，10－19200， 11－38400，12－57600，13－76800，14－115.2k;
        public byte byDataBit;         // 数据有几位 0－5位，1－6位，2－7位，3－8位;
        public byte byStopBit;         // 停止位 0－1位，1－2位;
    ...
    public static class NET_DVR_PPPCFG_V30 extends StructureFieldOrder {//ppp参数配置(子结构)
    ...
    public static class NET_DVR_PPPCFG extends StructureFieldOrder {//ppp参数配置(子结构)
    ...
    public static class NET_DVR_SINGLE_RS232 extends StructureFieldOrder {//RS232串口参数配置(9000扩展)
        public int dwBaudRate;   /*波特率(bps)，0－50，1－75，2－110，3－150，4－300，5－600，6－1200，7－2400，8－4800，9－9600，10－19200， 11－38400，12－57600，13－76800，14－115.2k;*/
        public byte byDataBit;     /* 数据有几位 0－5位，1－6位，2－7位，3－8位 */
        public byte byStopBit;     /* 停止位 0－1位，1－2位 */
        public byte byParity;      /* 校验 0－无校验，1－奇校验，2－偶校验 */
    ...
    public static class NET_DVR_RS232CFG_V30 extends StructureFieldOrder {//RS232串口参数配置(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_RS232CFG extends StructureFieldOrder {//RS232串口参数配置
        public int dwSize;
        public int dwBaudRate;//波特率(bps)，0－50，1－75，2－110，3－150，4－300，5－600，6－1200，7－2400，8－4800，9－9600，10－19200， 11－38400，12－57600，13－76800，14－115.2k;
        public byte byDataBit;// 数据有几位 0－5位，1－6位，2－7位，3－8位;
        public byte byStopBit;// 停止位 0－1位，1－2位;
    ...
    public static class NET_DVR_ALARMINCFG_V30 extends StructureFieldOrder {//报警输入参数配置(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_ALARMINCFG extends StructureFieldOrder {//报警输入参数配置
        public int dwSize;
        public byte[] sAlarmInName = new byte[NAME_LEN];	/* 名称 */
        public byte byAlarmType;    //报警器类型,0：常开,1：常闭
        public byte byAlarmInHandle;	/* 是否处理 0-不处理 1-处理*/
    ...
    public static class NET_DVR_ADDIT_POSITION extends StructureFieldOrder {//车载GPS信息结构(2007-12-27)
    ...
    public static class struRecordingHost extends StructureFieldOrder {
        public byte bySubAlarmType;
        public byte[] byRes1 = new byte[3];
        public NET_DVR_TIME_EX struRecordEndTime = new NET_DVR_TIME_EX();
    }

    public static class struAlarmHardDisk extends StructureFieldOrder {
        public int dwAlarmHardDiskNum;


    }

    public static class struAlarmChannel extends StructureFieldOrder {
    ...
    public static class struIOAlarm extends StructureFieldOrder {
    ...
    public static class NET_DVR_TIME_EX extends StructureFieldOrder {
        public short wYear;
        public byte byMonth;
        public byte byDay;
        public byte byHour;
    ...
    public static class NET_DVR_ALRAM_FIXED_HEADER extends StructureFieldOrder {
    ...
    public static class NET_DVR_ALARMINFO_V40 extends StructureFieldOrder {
    ...
    public static class NET_DVR_ALARMINFO_V30 extends StructureFieldOrder {//上传报警信息(9000扩展)
    ...
    public static class NET_DVR_ALARMINFO extends StructureFieldOrder {
    ...
    public static class NET_DVR_ALARMINFO_EX extends StructureFieldOrder {//上传报警信息(杭州竞天定制 2006-07-28)
    ...
    //////////////////////////////////////////////////////////////////////////////////////
    //IPC接入参数配置
    public static class NET_DVR_IPDEVINFO extends StructureFieldOrder {/* IP设备结构 */
    ...
    public static class NET_DVR_IPCHANINFO extends StructureFieldOrder {/* IP通道匹配参数 */
    ...
    public static class NET_DVR_IPPARACFG extends StructureFieldOrder {/* IP接入配置结构 */
    ...
    public class NET_DVR_IPDEVINFO_V31 extends StructureFieldOrder {
        public byte byEnable;/* 该通道是否启用 */
    ...
    public class NET_DVR_STREAM_MODE extends StructureFieldOrder {
    ...
    public class NET_DVR_IPSERVER_STREAM extends StructureFieldOrder {
    ...
    public class NET_DVR_STREAM_MEDIA_SERVER_CFG extends StructureFieldOrder {
    ...
    public class NET_DVR_DEV_CHAN_INFO extends StructureFieldOrder {
    ...
    public class NET_DVR_PU_STREAM_CFG extends StructureFieldOrder {
    ...
    public class NET_DVR_PU_STREAM_CFG_V41 extends StructureFieldOrder {
        public int dwSize;
    ...
    public class NET_DVR_DDNS_STREAM_CFG extends StructureFieldOrder {
        public byte byEnable;
        public byte[] byRes1 = new byte[3];
    ...
    public class NET_DVR_PU_STREAM_URL extends StructureFieldOrder {
    ...
    public class NET_DVR_HKDDNS_STREAM extends StructureFieldOrder {
    ...
    public class NET_DVR_IPCHANINFO_V40 extends StructureFieldOrder {
    ...
    public static class NET_DVR_IPPARACFG_V40 extends StructureFieldOrder {/* IP接入配置结构V40 */
        public int dwSize;   /* 结构大小 */
    ...
    public static class NET_DVR_IPALARMOUTINFO extends StructureFieldOrder {/* 报警输出参数 */
    ...
    public static class NET_DVR_IPALARMOUTCFG extends StructureFieldOrder {/* IP报警输出配置结构 */
        public int dwSize;			                        /* 结构大小 */
    ...
    public static class NET_DVR_IPALARMININFO extends StructureFieldOrder {/* 报警输入参数 */
        public byte byIPID;					/* IP设备ID取值1- MAX_IP_DEVICE */
    ...
    public static class NET_DVR_IPALARMINCFG extends StructureFieldOrder {/* IP报警输入配置结构 */
        public int dwSize;			                        /* 结构大小 */
    ...
    public static class NET_DVR_IPALARMINFO extends StructureFieldOrder {//ipc alarm info
        public NET_DVR_IPDEVINFO[] struIPDevInfo = new NET_DVR_IPDEVINFO[MAX_IP_DEVICE];            /* IP设备 */
    ...
    public static class NET_DVR_SINGLE_HD extends StructureFieldOrder {//本地硬盘信息配置
    ...
    public static class NET_DVR_SCALECFG extends StructureFieldOrder {//配置缩放参数的结构
        public int dwSize;
    ...
    public static class NET_DVR_ALARMOUTCFG_V30 extends StructureFieldOrder {//DVR报警输出(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_ALARMOUTCFG extends StructureFieldOrder {//DVR报警输出
        public int dwSize;
        public byte[] sAlarmOutName = new byte[NAME_LEN];	/* 名称 */
        public int dwAlarmOutDelay;	/* 输出保持时间(-1为无限，手动关闭) */
        //0-5秒,1-10秒,2-30秒,3-1分钟,4-2分钟,5-5分钟,6-10分钟,7-手动
    ...
    public static class NET_DVR_PREVIEWCFG_V30 extends StructureFieldOrder {//DVR本地预览参数(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_PREVIEWCFG extends StructureFieldOrder {//DVR本地预览参数
        public int dwSize;
    ...
    public static class NET_DVR_VGAPARA extends StructureFieldOrder {//DVR视频输出
     ...
     * MATRIX输出参数结构
     */
    public static class NET_DVR_MATRIXPARA_V30 extends StructureFieldOrder {
    ...
    public static class NET_DVR_MATRIXPARA extends StructureFieldOrder {
        public short wDisplayLogo;						/* 显示视频通道号(保留) */
        public short wDisplayOsd;						/* 显示时间(保留) */
    }

    public static class NET_DVR_VOOUT extends StructureFieldOrder {
    ...
    public static class NET_DVR_VIDEOOUT_V30 extends StructureFieldOrder {//DVR视频输出(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_VIDEOOUT extends StructureFieldOrder {//DVR视频输出
        public int dwSize;
    ...
    public static class NET_DVR_USER_INFO_V30 extends StructureFieldOrder {//单用户参数(子结构)(9000扩展)
        public byte[] sUserName = new byte[NAME_LEN];		/* 用户名 */
        public byte[] sPassword = new byte[PASSWD_LEN];		/* 密码 */
    ...
    public static class NET_DVR_USER_INFO_EX extends StructureFieldOrder {//单用户参数(SDK_V15扩展)(子结构)
        public byte[] sUserName = new byte[NAME_LEN];		/* 用户名 */
        public byte[] sPassword = new byte[PASSWD_LEN];		/* 密码 */
    ...
    public static class NET_DVR_USER_INFO extends StructureFieldOrder {//单用户参数(子结构)
        public byte[] sUserName = new byte[NAME_LEN];		/* 用户名 */
        public byte[] sPassword = new byte[PASSWD_LEN];		/* 密码 */
        public int[] dwLocalRight = new int[MAX_RIGHT];	/* 权限 */
        /*数组0: 本地控制云台*/
    ...
    public static class NET_DVR_USER_V30 extends StructureFieldOrder {//DVR用户参数(9000扩展)
        public int dwSize;
        public NET_DVR_USER_INFO_V30[] struUser = new NET_DVR_USER_INFO_V30[MAX_USERNUM_V30];
    }

    public static class NET_DVR_USER_EX extends StructureFieldOrder {//DVR用户参数(SDK_V15扩展)
        public int dwSize;
        public NET_DVR_USER_INFO_EX[] struUser = new NET_DVR_USER_INFO_EX[MAX_USERNUM];
    }

    public static class NET_DVR_USER extends StructureFieldOrder {//DVR用户参数
        public int dwSize;
        public NET_DVR_USER_INFO[] struUser = new NET_DVR_USER_INFO[MAX_USERNUM];
    }

    public static class NET_DVR_EXCEPTION_V30 extends StructureFieldOrder {//DVR异常参数(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_EXCEPTION extends StructureFieldOrder {//DVR异常参数
        public int dwSize;
    ...
    public static class NET_DVR_CHANNELSTATE_V30 extends StructureFieldOrder {//通道状态(9000扩展)
    ...
    public static class NET_DVR_CHANNELSTATE extends StructureFieldOrder {//通道状态
        public byte byRecordStatic; //通道是否在录像,0-不录像,1-录像
        public byte bySignalStatic; //连接的信号状态,0-正常,1-信号丢失
        public byte byHardwareStatic;//通道硬件状态,0-正常,1-异常,例如DSP死掉
    ...
    public static class NET_DVR_DISKSTATE extends StructureFieldOrder {//硬盘状态
        public int dwVolume;//硬盘的容量
        public int dwFreeSpace;//硬盘的剩余空间
        public int dwHardDiskStatic; //硬盘的状态,按位:1-休眠,2-不正常,3-休眠硬盘出错
    }

    public static class NET_DVR_WORKSTATE_V30 extends StructureFieldOrder {//DVR工作状态(9000扩展)
    ...
    public static class NET_DVR_WORKSTATE extends StructureFieldOrder {//DVR工作状态
        public int dwDeviceStatic;    //设备的状态,0-正常,1-CPU占用率太高,超过85%,2-硬件错误,例如串口死掉
    ...
    public static class NET_DVR_LOG_V30 extends StructureFieldOrder {//日志信息(9000扩展)
    ...
    //日志信息
    public static class NET_DVR_LOG extends StructureFieldOrder {
        public NET_DVR_TIME strLogTime;
        public int dwMajorType;    //主类型 1-报警; 2-异常; 3-操作; 0xff-全部
        public int dwMinorType;//次类型 0-全部;
        public byte[] sPanelUser = new byte[MAX_NAMELEN]; //操作面板的用户名
     ...
     * DVR日志 end
     ***************************/
    public static class NET_DVR_ALARMOUTSTATUS_V30 extends StructureFieldOrder {//报警输出状态(9000扩展)
        public byte[] Output = new byte[MAX_ALARMOUT_V30];
    }

    public static class NET_DVR_ALARMOUTSTATUS extends StructureFieldOrder {//报警输出状态
        public byte[] Output = new byte[MAX_ALARMOUT];
    }

    public static class NET_DVR_TRADEINFO extends StructureFieldOrder {//交易信息
        public short m_Year;
    ...
    public static class NET_DVR_FRAMETYPECODE extends StructureFieldOrder {/*帧格式*/
        public byte[] code = new byte[12];		/* 代码 */
    }

    public static class NET_DVR_FRAMEFORMAT_V30 extends StructureFieldOrder {//ATM参数(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_FRAMEFORMAT extends StructureFieldOrder {//ATM参数
        public int dwSize;
    ...
    public static class NET_DVR_FTPTYPECODE extends StructureFieldOrder {
        public byte[] sFtpType = new byte[32];     /*客户定义的操作类型*/
        public byte[] sFtpCode = new byte[8];      /*客户定义的操作类型的对应的码*/
    }

    public static class NET_DVR_FRAMEFORMAT_EX extends StructureFieldOrder {//ATM参数添加FTP上传参数, 俄罗斯银行定制, 2006-11-17
        public int dwSize;
        public byte[] sATMIP = new byte[16];						/* ATM IP地址 */
        public int dwATMType;						/* ATM类型 */
        public int dwInputMode;						/* 输入方式	0-网络侦听 1-网络接收 2-串口直接输入 3-串口ATM命令输入*/
     ...
     ***************************/
    //DS-6001D Decoder
    public static class NET_DVR_DECODERINFO extends StructureFieldOrder {
    ...
    public static class NET_DVR_DECODERSTATE extends StructureFieldOrder {
        public byte[] byEncoderIP = new byte[16];        //解码设备连接的服务器IP
        public byte[] byEncoderUser = new byte[16];        //解码设备连接的服务器的用户名
        public byte[] byEncoderPasswd = new byte[16];    //解码设备连接的服务器的密码
        public byte byEncoderChannel;        //解码设备连接的服务器的通道号
    ...
    public static class NET_DVR_DECCHANINFO extends StructureFieldOrder {
        public byte[] sDVRIP = new byte[16];				/* DVR IP地址 */
        public short wDVRPort;			 		/* 端口号 */
        public byte[] sUserName = new byte[NAME_LEN];		/* 用户名 */
        public byte[] sPassword = new byte[PASSWD_LEN];		/* 密码 */
    ...
    public static class NET_DVR_DECINFO extends StructureFieldOrder {/*每个解码通道的配置*/
    ...
    public static class NET_DVR_DECCFG extends StructureFieldOrder {/*整个设备解码配置*/
        public int dwSize;
    ...
    //2005-08-01
    public static class NET_DVR_PORTINFO extends StructureFieldOrder {/* 解码设备透明通道设置 */
    ...
    public static class NET_DVR_PORTCFG extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_PLAYREMOTEFILE extends StructureFieldOrder {/* 控制网络文件回放 */
        public int dwSize;
        public byte[] sDecoderIP = new byte[16];		/* DVR IP地址 */
        public short wDecoderPort;			/* 端口号 */
        ...
        public static class mode_size extends Union {
            ...
            public static class bytime extends StructureFieldOrder {
    ...
    public static class NET_DVR_DECCHANSTATUS extends StructureFieldOrder {/*当前设备解码连接状态*/
        ...
        public static class objectInfo extends Union {
            public static class userInfo extends StructureFieldOrder {
                public byte[] sUserName = new byte[NAME_LEN];    //请求视频用户名
                public byte[] sPassword = new byte[PASSWD_LEN];    // 密码
                public byte[] cReserve = new byte[52];
            }

            public static class fileInfo extends StructureFieldOrder {
                public byte[] fileName = new byte[100];
            }

            public static class timeInfo extends StructureFieldOrder {
                public int dwChannel;
                public byte[] sUserName = new byte[NAME_LEN];    //请求视频用户名
                public byte[] sPassword = new byte[PASSWD_LEN];    // 密码
                public NET_DVR_TIME struStartTime;        // 按时间回放的开始时间
    ...
    public static class NET_DVR_DECSTATUS extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_SHOWSTRINGINFO extends StructureFieldOrder {//单字符参数(子结构)
    ...
    //叠加字符(9000扩展)
    public static class NET_DVR_SHOWSTRING_V30 extends StructureFieldOrder {
        public int dwSize;
        public NET_DVR_SHOWSTRINGINFO[] struStringInfo = new NET_DVR_SHOWSTRINGINFO[MAX_STRINGNUM_V30];				/* 要显示的字符内容 */
    }

    //叠加字符扩展(8条字符)
    public static class NET_DVR_SHOWSTRING_EX extends StructureFieldOrder {
        public int dwSize;
        public NET_DVR_SHOWSTRINGINFO[] struStringInfo = new NET_DVR_SHOWSTRINGINFO[MAX_STRINGNUM_EX];				/* 要显示的字符内容 */
    }

    //叠加字符
    public static class NET_DVR_SHOWSTRING extends StructureFieldOrder {
        public int dwSize;
...
EMAIL参数结构
*/
    public static class NET_DVR_SENDER extends StructureFieldOrder {
        public byte[] sName = new byte[NAME_LEN];				/* 发件人姓名 */
        public byte[] sAddress = new byte[MAX_EMAIL_ADDR_LEN];		/* 发件人地址 */
    }

    public static class NET_DVRRECEIVER extends StructureFieldOrder {
        public byte[] sName = new byte[NAME_LEN];				/* 收件人姓名 */
        public byte[] sAddress = new byte[MAX_EMAIL_ADDR_LEN];		/* 收件人地址 */
    }

    public static class NET_DVR_EMAILCFG_V30 extends StructureFieldOrder {
        public int dwSize;
...
DVR实现巡航数据结构
*/
    public static class NET_DVR_CRUISE_PARA extends StructureFieldOrder {
        public int dwSize;
    ...
    //时间点
    public static class NET_DVR_TIMEPOINT extends StructureFieldOrder {
    ...
    //夏令时参数
    public static class NET_DVR_ZONEANDDST extends StructureFieldOrder {
        public int dwSize;
    ...
    //图片质量
    public static class NET_DVR_JPEGPARA extends StructureFieldOrder {
    ...
    //辅助输出参数配置
    public static class NET_DVR_AUXOUTCFG extends StructureFieldOrder {
        public int dwSize;
    ...
    //ntp
    public static class NET_DVR_NTPPARA extends StructureFieldOrder {
    ...
    //ddns
    public static class NET_DVR_DDNSPARA extends StructureFieldOrder {
    ...
    public static class NET_DVR_DDNSPARA_EX extends StructureFieldOrder {
    ...
    public static class NET_DVR_DDNS extends StructureFieldOrder {
    ...
    //9000扩展
    public static class NET_DVR_DDNSPARA_V30 extends StructureFieldOrder {
    ...
    //email
    public static class NET_DVR_EMAILPARA extends StructureFieldOrder {
    ...
    public static class NET_DVR_NETAPPCFG extends StructureFieldOrder {//网络参数配置
        public int dwSize;
    ...
    public static class NET_DVR_SINGLE_NFS extends StructureFieldOrder {//nfs结构配置
        public byte[] sNfsHostIPAddr = new byte[16];
        public byte[] sNfsDirectory = new byte[PATHNAME_LEN];        // PATHNAME_LEN = 128
    }

    public static class NET_DVR_NFSCFG extends StructureFieldOrder {
        public int dwSize;
        public NET_DVR_SINGLE_NFS[] struNfsDiskParam = new NET_DVR_SINGLE_NFS[MAX_NFS_DISK];
    }

    //巡航点配置(HIK IP快球专用)
    public static class NET_DVR_CRUISE_POINT extends StructureFieldOrder {
    ...
    public static class NET_DVR_CRUISE_RET extends StructureFieldOrder {
    ...
    public static class NET_DVR_NETCFG_OTHER extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_MATRIX_DECINFO extends StructureFieldOrder {
        public byte[] sDVRIP = new byte[16];				/* DVR IP地址 */
        public short wDVRPort;			 	/* 端口号 */
        public byte byChannel;				/* 通道号 */
    ...
    public static class NET_DVR_MATRIX_DYNAMIC_DEC extends StructureFieldOrder {//启动/停止动态解码
        public int dwSize;
        public NET_DVR_MATRIX_DECINFO struDecChanInfo;		/* 动态解码通道信息 */
    }

    public static class NET_DVR_MATRIX_DEC_CHAN_STATUS extends StructureFieldOrder {//2007-12-13 modified by zxy 修改多路解码器的NET_DVR_MATRIX_DEC_CHAN_STATUS结构
    ...
    public static class NET_DVR_MATRIX_DEC_CHAN_INFO extends StructureFieldOrder {
        public int dwSize;
    ...
    //连接的通道配置 2007-11-05
    public static class NET_DVR_MATRIX_DECCHANINFO extends StructureFieldOrder {
        public int dwEnable;					/* 是否启用 0－否 1－启用*/
        public NET_DVR_MATRIX_DECINFO struDecChanInfo;		/* 轮循解码通道信息 */
    }

    //2007-11-05 新增每个解码通道的配置
    public static class NET_DVR_MATRIX_LOOP_DECINFO extends StructureFieldOrder {
        public int dwSize;
    ...
    //矩阵行信息 2007-12-28
    public static class NET_DVR_MATRIX_ROW_ELEMENT extends StructureFieldOrder {
    ...
    public static class NET_DVR_MATRIX_ROW_INDEX extends StructureFieldOrder {
        public byte[] sSurvChanName = new byte[128];			/* 监控通道名称，支持中文 */
        public int dwRowNum;				/* 行号 */
    }

    //矩阵列信息 2007-12-28
    public static class NET_DVR_MATRIX_COLUMN_ELEMENT extends StructureFieldOrder {
        public int dwLocalDispChanNum;	/* 本地显示通道号 */
        public int dwGlobalDispChanNum;	/* 全局显示通道号 */
        public int dwRes;			/* 保留 */
    }

    public static class NET_DVR_MATRIX_GLOBAL_COLUMN_ELEMENT extends StructureFieldOrder {
    ...
    //手动查看 2007-12-28
    public static class NET_DVR_MATRIX_ROW_COLUMN_LINK extends StructureFieldOrder {
        public int dwSize;
        /*
    ...
    public static class NET_DVR_MATRIX_PREVIEW_DISP_CHAN extends StructureFieldOrder {
        public int dwSize;
        public int dwGlobalDispChanNum;		/* 电视墙上的电视机编号 */
        public int dwLocalDispChanNum;		/* 解码通道 */
    }

    public static class NET_DVR_MATRIX_LOOP_PLAY_SET extends StructureFieldOrder {//轮循功能 2007-12-28
        public int dwSize;
    ...
    public static class NET_DVR_MATRIX_LOCAL_HOST_INFO extends StructureFieldOrder {//矩阵中心配置 2007-12-28
        public int dwSize;
    ...
    //2007-12-22
    public static class TTY_CONFIG extends StructureFieldOrder {
    ...
    public static class NET_DVR_MATRIX_TRAN_CHAN_INFO extends StructureFieldOrder {
    ...
    public static class NET_DVR_MATRIX_TRAN_CHAN_CONFIG extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_MATRIX_DEC_REMOTE_PLAY extends StructureFieldOrder {
        public int dwSize;
        public byte[] sDVRIP = new byte[16];		/* DVR IP地址 */
        public short wDVRPort;			/* 端口号 */
        public byte byChannel;			/* 通道号 */
    ...
    public static class NET_DVR_MATRIX_DEC_REMOTE_PLAY_CONTROL extends StructureFieldOrder {
        public int dwSize;
        public int dwPlayCmd;		/* 播放命令 见文件播放命令*/
        public int dwCmdParam;		/* 播放命令参数 */
    }

    public static class NET_DVR_MATRIX_DEC_REMOTE_PLAY_STATUS extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_MATRIX_PASSIVEMODE extends StructureFieldOrder {
    ...
    public static class NET_DVR_VIDEO_WALL_INFO extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_SCENE_CONTROL_INFO extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_BUF_INFO extends StructureFieldOrder {
        public Pointer pBuf;
        public int nLen;
    }

    public static class NET_DVR_IN_PARAM extends StructureFieldOrder {
    ...
    public static class NET_DVR_OUT_PARAM extends StructureFieldOrder {
        public NET_DVR_BUF_INFO struOutBuf;
        public Pointer lpStatusList;
        public byte[] byRes = new byte[32];
    }

    public static class NET_DVR_RECTCFG_EX extends StructureFieldOrder {
    ...
    public static class NET_DVR_VIDEOWALLWINDOWPOSITION extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_WALLWINPARAM extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_PLAN_LIST extends StructureFieldOrder {
        public int dwSize;
    ...
    /*预案项信息*/
    public static class NET_DVR_PLAN_INFO extends StructureFieldOrder {
    ...
    public static class NET_DVR_CYCLE_TIME extends StructureFieldOrder {
        public byte byValid;
        public byte[] byRes = new byte[3];
    ...
    /*预案管理*/
    public static class NET_DVR_PLAN_CFG extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_WALLSCENECFG extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_SUBWND_DECODE_OSD extends StructureFieldOrder {
        public int dwSize = 0;
    ...
    public static class NET_DVR_OSD_INFO extends StructureFieldOrder {
    ...
    public static class NET_DVR_DEV_CHAN_INFO_EX extends StructureFieldOrder {
    ...
    public static class NET_DVR_STREAM_MEDIA_SERVER extends StructureFieldOrder {
    ...
    public static class NET_DVR_DEV_DDNS_INFO extends StructureFieldOrder {
    ...
    public static class NET_DVR_DEC_STREAM_DEV_EX extends StructureFieldOrder {
    ...
    //DDNS方式取流
    public static class NET_DVR_DEC_DDNS_DEV extends StructureFieldOrder {
    ...
    public static class NET_DVR_MATRIX_CHAN_INFO_V41 extends StructureFieldOrder {
    ...
    public static class NET_DVR_MATRIX_LOOP_DECINFO_V41 extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_EMAILCFG extends StructureFieldOrder {	/* 12 bytes */
        public int dwSize;
    ...
    public static class NET_DVR_COMPRESSIONCFG_NEW extends StructureFieldOrder {
        public int dwSize;
    ...
    //球机位置信息
    public static class NET_DVR_PTZPOS extends StructureFieldOrder {
    ...
    //球机范围信息
    public static class NET_DVR_PTZSCOPE extends StructureFieldOrder {
    ...
    public static class NET_DVR_PTZABSOLUTEEX_CFG extends StructureFieldOrder {
        public int dwSize;//结构体大小
    ...
    //rtsp配置 ipcamera专用
    public static class NET_DVR_RTSPCFG extends StructureFieldOrder {
    ...
    //NET_DVR_Login()参数结构
    public static class NET_DVR_DEVICEINFO extends StructureFieldOrder {
        public byte[] sSerialNumber = new byte[SERIALNO_LEN];   //序列号
        public byte byAlarmInPortNum;                //DVR报警输入个数
        public byte byAlarmOutPortNum;                //DVR报警输出个数
    ...
    public static class NET_DVR_DEVICEINFO_V30 extends StructureFieldOrder {
        public byte[] sSerialNumber = new byte[SERIALNO_LEN];  //序列号
    ...
    public static class NET_DVR_USER_LOGIN_INFO extends StructureFieldOrder {
    ...
    //NET_DVR_Login_V40()参数
    public static class NET_DVR_DEVICEINFO_V40 extends StructureFieldOrder {
    ...
    //软解码预览参数
    public static class NET_DVR_CLIENTINFO extends StructureFieldOrder {
        public int lChannel;
    ...
    //预览V40接口
    public static class NET_DVR_PREVIEWINFO extends StructureFieldOrder {
    ...
    public static class NET_DVR_STREAM_INFO extends StructureFieldOrder {
        public int dwSize;
    ...
    //配置条件
    public static class NET_DVR_CLOUDSTORAGE_COND extends StructureFieldOrder {
        public int dwSize;
        public int dwChannel;
        public byte[] byRes1 = new byte[64];
    }

    public static class NET_DVR_STREAM_RECORD_STATUS extends StructureFieldOrder {
        public int dwSize;
    ...
    //SDK状态信息(9000新增)
    public static class NET_DVR_SDKSTATE extends StructureFieldOrder {
    ...
    //SDK功能支持信息(9000新增)
    public static class NET_DVR_SDKABL extends StructureFieldOrder {
    ...
    //报警设备信息
    public static class NET_DVR_ALARMER extends StructureFieldOrder {
    ...
    //硬解码显示区域参数(子结构)
    public static class NET_DVR_DISPLAY_PARA extends StructureFieldOrder {
    ...
    //硬解码预览参数
    public static class NET_DVR_CARDINFO extends StructureFieldOrder {
        public int lChannel;//通道号
    ...
    //录象文件参数
    public static class NET_DVR_FIND_DATA extends StructureFieldOrder {
    ...
    //录象文件参数(9000)
    public static class NET_DVR_FINDDATA_V30 extends StructureFieldOrder {
        public byte[] sFileName = new byte[100];//文件名
        public NET_DVR_TIME struStartTime;//文件的开始时间
        public NET_DVR_TIME struStopTime;//文件的结束时间
        public int dwFileSize;//文件的大小
    ...
    //录象文件参数(带卡号)
    public static class NET_DVR_FINDDATA_CARD extends StructureFieldOrder {
        public byte[] sFileName = new byte[100];//文件名
        public NET_DVR_TIME struStartTime;//文件的开始时间
        public NET_DVR_TIME struStopTime;//文件的结束时间
        public int dwFileSize;//文件的大小
    ...
    public static class NET_DVR_FILECOND_V40 extends StructureFieldOrder {
        public int lChannel;
    ...
    public static class NET_DVR_ATMFINDINFO extends StructureFieldOrder {
    ...
    //录像文件查找条件结构V50
    public static class NET_DVR_FILECOND_V50 extends StructureFieldOrder {
    ...
    public static class NET_DVR_FINDDATA_V40 extends StructureFieldOrder {
        public byte[] sFileName = new byte[100];//文件名
    ...
    public static class NET_DVR_TIME_SEARCH extends StructureFieldOrder {
    ...
    public static class NET_DVR_ADDRESS extends StructureFieldOrder {
        public NET_DVR_IPADDR struIP = new NET_DVR_IPADDR(); //IP地址
        public short wPort;    //端口号
        public byte[] byRes = new byte[2];
    }

    public static class NET_DVR_FINDDATA_V50 extends StructureFieldOrder {
    ...
    public static class NET_DVR_FILECOND extends StructureFieldOrder //录象文件查找条件结构
    {
        public int lChannel;//通道号
    ...
    public static class NET_DVR_PLAYCOND extends StructureFieldOrder //回放或者下载信息结构体
    {
        public int dwChannel;//通道号
    ...
    public static class NET_DVR_VOD_PARA extends StructureFieldOrder //回放或者下载信息结构体
    {
        public int dwSize;
    ...
    //图片查找条件
    public static class NET_DVR_FIND_PICTURE_PARAM extends StructureFieldOrder {
        public int dwSize;         // 结构体大小
        public int lChannel;       // 通道号
    ...
    public static class NET_DVR_FIND_PICTURE extends StructureFieldOrder
    {
    ...
    public class NET_DVR_FIND_PICTURE_V50 extends StructureFieldOrder {
        public byte[] sFileName = new byte[PICTURE_NAME_LEN];//图片名
    ...
    public class NET_DVR_PIC_PARAM extends StructureFieldOrder {
    ...
    //查找结果结构体
    public static class NET_DVR_FIND_PICTURE_V40 extends StructureFieldOrder {
        public byte[] sFileName = new byte[PICTURE_NAME_LEN];//图片名
        public NET_DVR_TIME struTime = new NET_DVR_TIME();//图片的时间
        public int dwFileSize;//图片的大小
        public byte[] sCardNum = new byte[CARDNUM_LEN_V30];    //卡号
    ...
    //云台区域选择放大缩小(HIK 快球专用)
    public static class NET_DVR_POINT_FRAME extends StructureFieldOrder {
    ...
    //音频解码
    public static class NET_DVR_AUDIODEC_PROCESS_PARAM extends StructureFieldOrder {
    ...
    //用于接收报警信息的缓存区
    public static class RECV_ALARM extends StructureFieldOrder {
        public byte[] RecvBuffer = new byte[4000];//此处的400应不小于最大报警报文长度
    }

    //布防参数
    public static class NET_DVR_SETUPALARM_PARAM extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_SETUPALARM_PARAM_V50 extends StructureFieldOrder {
        public int dwSize;
        public byte byLevel; //布防优先级，0-一等级（高），1-二等级（中），2-三等级（低）
        public byte byAlarmInfoType; //上传报警信息类型（抓拍机支持），0-老报警信息（NET_DVR_PLATE_RESULT），1-新报警信息(NET_ITS_PLATE_RESULT)2012-9-28
        public byte byRetAlarmTypeV40; //0--返回NET_DVR_ALARMINFO_V30或NET_DVR_ALARMINFO, 1--设备支持NET_DVR_ALARMINFO_V40则返回NET_DVR_ALARMINFO_V40，不支持则返回NET_DVR_ALARMINFO_V30或NET_DVR_ALARMINFO
    ...
    //区域框参数
    public static class NET_VCA_RECT extends StructureFieldOrder {
        public float fX;
        public float fY;
        public float fWidth;
    ...
    //报警目标信息
    public static class NET_VCA_TARGET_INFO extends StructureFieldOrder {
        public int dwID;
    ...
    //前端设备信息
    public static class NET_VCA_DEV_INFO extends StructureFieldOrder {
    ...
    //事件规则信息
    public static class NET_VCA_RULE_INFO extends StructureFieldOrder {
    ...
    //穿越警戒面参数
    public static class NET_VCA_TRAVERSE_PLANE extends StructureFieldOrder {
    ...
    public static class NET_DVR_HANDLEEXCEPTION_V40 extends StructureFieldOrder {
    ...
    public static class NET_VCA_TRAVERSE_PLANE_DETECTION extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_VCA_INTRUSION extends StructureFieldOrder {
    ...
    */
    ...
    //快速移动参数
    public static class NET_VCA_RUN extends StructureFieldOrder {
        public NET_VCA_POLYGON struRegion;//区域范围
    ...
    */
    ...
    //奔跑检测
    public static class NET_VCA_RUNNING extends StructureFieldOrder {
        public NET_VCA_POLYGON struRegion;  //区域范围
    ...
    //倒地参数
    public static class NET_VCA_FALL_DOWN extends StructureFieldOrder {
        public NET_VCA_POLYGON struRegion;//区域范围
    ...
    public static class NET_VCA_FIELDDETECION extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_CHANNEL_GROUP extends StructureFieldOrder {
        public int dwSize;
        public int dwChannel;
        public int dwGroup;
        public byte byID;
    ...
    //线结构参数
    public static class NET_VCA_LINE extends StructureFieldOrder {
        public NET_VCA_POINT struStart;
        public NET_VCA_POINT struEnd;
    }

    //点坐标参数
    public static class NET_VCA_POINT extends StructureFieldOrder {
        public float fX;
        public float fY;
    ...
    //进入/离开区域参数
    public static class NET_VCA_AREA extends StructureFieldOrder {
        public NET_VCA_POLYGON struRegion;
        public byte[] byRes = new byte[8];
    }

    //多边形结构体
    public static class NET_VCA_POLYGON extends StructureFieldOrder {
        public int dwPointNum;
        public NET_VCA_POINT[] struPos = new NET_VCA_POINT[VCA_MAX_POLYGON_POINT_NUM];
    }

    public static class NET_VCA_SIZE_FILTER extends StructureFieldOrder {
    ...
    //尺寸过滤策略
    public static class NET_VCA_FILTER_STRATEGY extends StructureFieldOrder {
        public byte byStrategy;      //尺寸过滤策略 0 - 不启用 1-高度和宽度过滤,2-面积过滤
        public byte[] byRes = new byte[11];       //保留
    }

    //行为分析报警
    public static class NET_VCA_RULE_ALARM extends StructureFieldOrder {
        public int dwSize;
        public int dwRelativeTime;
    ...
    public static class NET_DVR_SYSTEM_TIME extends StructureFieldOrder {
    ...
    public static class NET_AIOP_VIDEO_HEAD extends StructureFieldOrder {
    ...
    public static class NET_AIOP_PICTURE_HEAD extends StructureFieldOrder {
    ...
    public static class NET_DVR_AI_PICTUR_UPLOAD extends StructureFieldOrder {
        public int dwSize;
    ...
    // AI开放平台接入轮询视频检测报警结构体。
    public static class NET_AIOP_POLLING_SNAP_HEAD extends StructureFieldOrder {
    ...
    //规则触发参数
    public static class NET_VCA_RULE_TRIGGER_PARAM extends StructureFieldOrder {
    ...
    public static class NET_VCA_ONE_RULE_V42 extends StructureFieldOrder {
    ...
    public static class NET_DVR_PTZ_POSITION extends StructureFieldOrder {
    ...
    //行为分析配置结构体
    public static class NET_VCA_RULECFG_V42 extends StructureFieldOrder {
    ...
    public static class NET_DVR_CID_ALARM extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_SENSOR_ALARM extends StructureFieldOrder {
        public int dwSize;                // 结构体大小
    ...
    //开关量报警上传
    public static class NET_DVR_SWITCH_ALARM extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_ALARMHOST_EXCEPTION_ALARM extends StructureFieldOrder {
        public int dwSize;             // 结构体大小
    ...
    public static class NET_DVR_ALARMHOST_POINT_VALUE extends StructureFieldOrder {
    ...
    public static class NET_DVR_ALARMHOST_DATA_UNION extends StructureFieldOrder {
        public byte[] byLength = new byte[40];
        public NET_DVR_ALARMHOST_POINT_VALUE struPointValue;    //监测点实时数据
    }

    public static class NET_DVR_ALARMHOST_DATA_UPLOAD extends StructureFieldOrder {
        public int dwSize;
    ...
    //车牌识别结果子结构
    public static class NET_DVR_PLATE_INFO extends StructureFieldOrder {
    ...
    public static class NET_DVR_VEHICLE_INFO extends StructureFieldOrder {
    ...
    */
    ...
    //手动抓拍
    public static class NET_DVR_MANUALSNAP extends StructureFieldOrder {
    ...
    //交通抓拍结果信息
    public static class NET_DVR_PLATE_RESULT extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_TIME_V30 extends StructureFieldOrder {
        public short wYear;
        public byte byMonth;
        public byte byDay;
        public byte byHour;
    ...
    public static class NET_ITS_PICTURE_INFO extends StructureFieldOrder {
    ...
    public static class NET_ITS_PLATE_RESULT extends StructureFieldOrder {
        public int dwSize;
    ...
    //停车场数据上传
    public static class NET_ITS_PARK_VEHICLE extends StructureFieldOrder {
    ...
    public static class NET_DVR_SNAPCFG extends StructureFieldOrder {
    ...
    // 道闸控制
    public static class NET_DVR_BARRIERGATE_CFG extends StructureFieldOrder {
        public int dwSize;
        public int dwChannel; //通道号
    ...
    */
    ...
    public static class NET_DVR_AGEGROUP_PARAM extends StructureFieldOrder {
    ...
    public static class NET_DVR_SEXGROUP_PARAM extends StructureFieldOrder {
        public int dwMale;//男（人数）
        public int dwFemale;//女（人数）
        public byte[] byRes = new byte[64];
    }

    public static class NET_DVR_PROGRAM_INFO extends StructureFieldOrder {
        public int dwProgramNo; //节目编号
        public byte[] sProgramName = new byte[NAME_LEN]; //节目名称
        public byte[] byRes = new byte[16];
    }

    public static class NET_DVR_FACECAPTURE_STATISTICS_RESULT extends StructureFieldOrder {
        public int dwSize;
    ...
    //获取交通数据条件结构
    public static class NET_DVR_TRAFFIC_DATA_QUERY_COND extends StructureFieldOrder {
        public int dwSize;
        /*
       Bit0-通道有效
       Bit1-时间有效
    ...
    //交通数据结构体
    public static class NET_DVR_TRAFFIC_DATA_QUERY_RESULT extends StructureFieldOrder {
        public int dwSize;
    ...
    */
    ...
    public static class NET_DVR_TRAFFIC_PICTURE_PARAM extends StructureFieldOrder {
    ...
    public static class NET_DVR_VEHICLE_CONTROL_COND extends StructureFieldOrder {
        public int dwChannel;
    ...
    public static class NET_DVR_VEHICLE_CONTROL_LIST_INFO extends StructureFieldOrder {
        public int dwSize;
        public int dwChannel;
        public int dwDataIndex;
    ...
    //车辆报警
    public static class NET_DVR_VEHICLE_CONTROL_ALARM extends StructureFieldOrder {
        public int dwSize;
    ...
    //LED屏幕显示参数
    public static class NET_DVR_LEDDISPLAY_CFG extends StructureFieldOrder {
        public int dwSize;//结构体大小
    ...
    //语音播报控制参数
    public static class NET_DVR_VOICEBROADCAST_CFG extends StructureFieldOrder {
        public int dwSize;//结构体大小
    ...
    //缴费金额信息
    public static class NET_DVR_CHARGEACCOUNT_CFG extends StructureFieldOrder {
        public int dwSize;//结构体大小
    ...
    public static class NET_DVR_DOOR_CFG extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_DOOR_STATUS_PLAN extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_EVENT_CARD_LINKAGE_COND extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_EVENT_CARD_LINKAGE_CFG_V50 extends StructureFieldOrder {
        public int dwSize;    //结构体大小
    ...
    public static class NET_DVR_EVENT_LINKAGE_INFO extends StructureFieldOrder {
    ...
    //卡参数配置条件
    public static class NET_DVR_CARD_CFG_COND extends StructureFieldOrder {
        public int dwSize;
    ...
    //获取卡参数的发送数据
    public static class NET_DVR_CARD_CFG_SEND_DATA extends StructureFieldOrder {
        public int dwSize;
        public byte[] byCardNo = new byte[32];
        public byte[] byRes = new byte[16];
    }

    public static class CARDRIGHTPLAN extends StructureFieldOrder {
        public byte[] byRightPlan = new byte[4];
    }

    //卡参数
    public static class NET_DVR_CARD_CFG extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class CARDRIGHTPLAN_WORD extends StructureFieldOrder {
        public short[] wRightPlan = new short[MAX_CARD_RIGHT_PLAN_NUM];
    }

    public static class NET_DVR_CARD_CFG_V50 extends StructureFieldOrder {
        public int dwSize;
    ...
    //有效期参数结构体
    public static class NET_DVR_VALID_PERIOD_CFG extends StructureFieldOrder {
        public byte byEnable;
        public byte[] byRes1 = new byte[3];
    ...
    //扩展结构体信息
    public static class NET_DVR_ID_CARD_INFO_EXTEND extends StructureFieldOrder {
    ...
    //身份证信息报警
    public static class NET_DVR_ID_CARD_INFO_ALARM extends StructureFieldOrder {
        public int dwSize;        //结构长度
    ...
    public static class NET_DVR_CARD_READER_CFG_V50 extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_CARD_COND extends StructureFieldOrder {
        public int dwSize;
        public int dwCardNum; //设置或获取卡数量，获取时置为0xffffffff表示获取所有卡信息
        public byte[] byRes = new byte[64];
    }

    public static class NET_DVR_CARD_SEND_DATA extends StructureFieldOrder {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN]; //卡号
        public byte[] byRes = new byte[16];
    }

    public static class NET_DVR_CARD_RECORD extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_CARD_STATUS extends StructureFieldOrder {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN];
    ...
    public static class NET_DVR_FACE_COND extends StructureFieldOrder {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN];
    ...
    public static class NET_DVR_FACE_RECORD extends StructureFieldOrder {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN];
    ...
    public static class NET_DVR_FACE_STATUS extends StructureFieldOrder {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN];
    ...
    public static class NET_DVR_FINGERPRINT_COND extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_FINGERPRINT_RECORD extends StructureFieldOrder {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN];
    ...
    public static class NET_DVR_FINGERPRINT_STATUS extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_CAPTURE_FINGERPRINT_COND extends StructureFieldOrder {
        public int dwSize;
    ...
    //
    public static class NET_DVR_CAPTURE_FINGERPRINT_CFG extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_FINGER_PRINT_INFO_CTRL_V50 extends StructureFieldOrder
    {
        public int dwSize;
    ...
    public static class NET_DVR_FINGER_PRINT_BYREADER_V50 extends StructureFieldOrder
    {
    ...
    public static class NET_DVR_FINGER_PRINT_BYCARD_V50 extends StructureFieldOrder
    {
        public byte[]  byCardNo = new byte[ACS_CARD_NO_LEN]; //指纹关联的卡号
    ...
    //人脸删除控制参数结构体
    public static class NET_DVR_FACE_PARAM_CTRL extends StructureFieldOrder {
        public int dwSize;
    ...
    //指纹删除控制参数结构体
    public static class NET_DVR_FINGER_PRINT_INFO_CTRL extends StructureFieldOrder {
        public int dwSize;
        public byte byMode;          //删除方式，0-按卡号方式删除，1-按读卡器删除
        public byte[] byRes1 = new byte[3];        //保留
    ...
    public static class NET_DVR_FINGER_PRINT_BYCARD extends StructureFieldOrder {
    ...
    public static class NET_DVR_FINGER_PRINT_BYREADER extends StructureFieldOrder {
    ...
    //门禁主机参数
    public static class NET_DVR_ACS_CFG extends StructureFieldOrder {
        public int dwSize;            //结构体大小
     ...
     * 优化接口结构体定义结束
     ***************************/
    public static class NET_DVR_UPLOAD_ID_BLOCKLIST_COND extends StructureFieldOrder
    {
        public    int       dwSize;
    ...
    public static class NET_DVR_UPLOAD_ID_BLOCKLIST_CFG extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_UPLOAD_ID_BLOCKLIST_STATUS extends StructureFieldOrder
    {
        public int       dwSize;
    ...
    public static class REMOTECONFIGSTATUS extends StructureFieldOrder {
    ...
    //开锁记录
    public static class NET_DVR_UNLOCK_RECORD_INFO extends StructureFieldOrder {
    ...
    //公告信息阅读回执
    public static class NET_DVR_NOTICEDATA_RECEIPT_INFO extends StructureFieldOrder {
        public byte[] byNoticeNumber = new byte[MAX_NOTICE_NUMBER_LEN]; //公告编号
        public byte[] byRes = new byte[224];  //保留
    }

    //认证记录（设备未实现）
    public static class NET_DVR_AUTH_INFO extends StructureFieldOrder {
    ...
    //车牌信息上传
    public static class NET_DVR_UPLOAD_PLATE_INFO extends StructureFieldOrder {
        public byte[] sLicense = new byte[MAX_LICENSE_LEN];        //车牌号码
        public byte byColor;                      //车牌颜色，参考结构VCA_PLATE_COLOR
        public byte[] byRes = new byte[239];  //保留
    }

    public static class NET_DVR_SEND_CARD_INFO extends StructureFieldOrder {
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN/*32*/]; //卡号
        public byte[] byRes = new byte[224];  //保留
    }
    ...
    //可视对讲事件记录
    public static class NET_DVR_VIDEO_INTERCOM_EVENT extends StructureFieldOrder {
        public int dwSize; //结构体大小
    ...
    public static class NET_DVR_CONTROL_GATEWAY extends StructureFieldOrder {
        public int dwSize; //结构体大小
    ...
    //公告图片信息结构体
    public static class NET_DVR_NOTICE_PIC extends StructureFieldOrder {
    ...
    //公告数据
    public static class NET_DVR_NOTICE_DATA extends StructureFieldOrder {
        public int dwSize; //结构体大小
    ...
    public static class NET_DVR_DATE extends StructureFieldOrder {
        public short wYear;        //年
    ...
    //身份证信息
    public static class NET_DVR_ID_CARD_INFO extends StructureFieldOrder {
        public int dwSize;        //结构长度
    ...
    public static class NET_DVR_ACS_EVENT_INFO_EXTEND_V20 extends StructureFieldOrder {
        public byte byRemoteCheck; //是否需要远程核验（0-无效，1-不需要（默认），2-需要）
        public byte byThermometryUnit; //测温单位（0-摄氏度（默认），1-华氏度，2-开尔文）
        public byte byIsAbnomalTemperature; //人脸抓拍测温是否温度异常：1-是，0-否
        public byte byRes2;
    ...
    //门禁主机报警信息结构体
    public static class NET_DVR_ACS_ALARM_INFO extends StructureFieldOrder {
        public int dwSize;
        public int dwMajor; //报警主类型，参考宏定义
        public int dwMinor; //报警次类型，参考宏定义
    ...
    //门禁主机事件信息
    public static class NET_DVR_ACS_EVENT_INFO extends StructureFieldOrder {
        public int dwSize;
        public byte[] byCardNo = new byte[32];
        public byte byCardType;
    ...
    public static class NET_DVR_ACS_EVENT_INFO_EXTEND extends StructureFieldOrder {
    ...
    门禁主机报警事件细节结构体
     */
    public static class NET_DVR_ACS_EVENT_DETAIL extends StructureFieldOrder {
        public int dwSize;
    ...
    门禁主机报警事件配置结构体
     */
    public static class NET_DVR_ACS_EVENT_CFG extends StructureFieldOrder {
        public int dwSize;
        public int dwMajor; //报警主类型，参考宏定义
        public int dwMinor; //报警次类型，参考宏定义
        public NET_DVR_TIME struTime = new NET_DVR_TIME(); //时间
    ...
    public static class NET_DVR_ACS_EVENT_COND extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_ACS_WORK_STATUS_V50 extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_ACS_PARAM_TYPE extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_FACE_PARAM_COND extends StructureFieldOrder {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN];    //人脸关联的卡号
    ...
    public static class NET_DVR_FACE_PARAM_CFG extends StructureFieldOrder {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN];    //人脸关联的卡号
    ...
    public static class NET_DVR_FACE_PARAM_STATUS extends StructureFieldOrder {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN]; //人脸关联的卡号
    ...
    public static class NET_DVR_FACE_PARAM_BYCARD extends StructureFieldOrder {
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN]; //人脸关联的卡号
        public byte[] byEnableCardReader = new byte[MAX_CARD_READER_NUM_512];  //人脸的读卡器信息，按数组表示
        public byte[] byFaceID = new byte[MAX_FACE_NUM];        //需要删除的人脸编号，按数组下标，值表示0-不删除，1-删除该人脸
    ...
    public static class NET_DVR_FACE_PARAM_BYREADER extends StructureFieldOrder {
        public int dwCardReaderNo;  //按值表示，人脸读卡器编号
        public byte byClearAllCard;  //是否删除所有卡的人脸信息，0-按卡号删除人脸信息，1-删除所有卡的人脸信息
        public byte[] byRes1 = new byte[3];       //保留
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN]; //人脸关联的卡号
    ...
    public static class NET_DVR_CHECK_FACE_PICTURE_COND extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_CHECK_FACE_PICTURE_CFG extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_CHECK_FACE_PICTURE_STATUS extends StructureFieldOrder {
        public int dwSize;
        public int dwPictureNo; //图片编号
    ...
    public static class NET_DVR_FINGER_PRINT_CFG_V50 extends StructureFieldOrder {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN]; //指纹关联的卡号
        public int dwFingerPrintLen;    //指纹数据长度
    ...
    public static class NET_DVR_FINGER_PRINT_STATUS_V50 extends StructureFieldOrder {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN]; //指纹关联的卡号
    ...
    public static class NET_DVR_FINGER_PRINT_INFO_COND_V50 extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_GROUP_CFG extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_MULTI_CARD_CFG_V50 extends StructureFieldOrder
    {
        public int                               dwSize;
        public byte                              byEnable;
    ...
    public static class NET_DVR_MULTI_CARD_GROUP_CFG_V50 extends StructureFieldOrder
    {
        public byte     byEnable;
    ...
    public static class NET_DVR_GROUP_COMBINATION_INFO_V50 extends StructureFieldOrder
    {
        public byte     byEnable;
    ...
    //自定义结构体，用于二维数组转换
    public static class NET_DVR_SINGLE_PLAN_SEGMENT_WEEK extends StructureFieldOrder {
        public NET_DVR_SINGLE_PLAN_SEGMENT[] struPlanCfgDay = new NET_DVR_SINGLE_PLAN_SEGMENT[MAX_TIMESEGMENT_V30]; //一天的计划参数
    }

    public static class NET_DVR_WEEK_PLAN_CFG extends StructureFieldOrder {
        public int dwSize;
        public byte byEnable;  //是否使能，1-使能，0-不使能
        public byte[] byRes1 = new byte[3];
    ...
    public static class NET_DVR_SINGLE_PLAN_SEGMENT extends StructureFieldOrder {
        public byte byEnable; //是否使能，1-使能，0-不使能
    ...
    public static class NET_DVR_TIME_SEGMENT extends StructureFieldOrder {
        public NET_DVR_SIMPLE_DAYTIME struBeginTime; //开始时间点
        public NET_DVR_SIMPLE_DAYTIME struEndTime;   //结束时间点
    }

    public static class NET_DVR_SIMPLE_DAYTIME extends StructureFieldOrder {
    ...
    public static class NET_DVR_WEEK_PLAN_COND extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_PLAN_TEMPLATE extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_PLAN_TEMPLATE_COND extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_CAPTURE_FACE_COND extends StructureFieldOrder {
        public int dwSize;
        public byte[] byRes = new byte[128];
    }

    public static class NET_DVR_FACE_FEATURE extends StructureFieldOrder {
    ...
    public static class NET_DVR_CAPTURE_FACE_CFG extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_XML_CONFIG_INPUT extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_STRING_POINTER extends StructureFieldOrder {
    ...
    public static class NET_DVR_XML_CONFIG_OUTPUT extends StructureFieldOrder {
        public int dwSize;
    ...
    //报警场景信息
    public static class NET_DVR_SCENE_INFO extends StructureFieldOrder {
    ...
    // 方向结构体
    public static class NET_DVR_DIRECTION extends StructureFieldOrder {
        public NET_VCA_POINT struStartPoint = new NET_VCA_POINT();   // 方向起始点
        public NET_VCA_POINT struEndPoint = new NET_VCA_POINT();     // 方向结束点
    }

    // 交通事件信息
    public static class NET_DVR_AID_INFO extends StructureFieldOrder {
    ...
    //交通取证报警
    public static class NET_DVR_TFS_ALARM extends StructureFieldOrder {
        public int dwSize;                //结构体大小
    ...
    public static class NET_ITS_OVERLAPCFG_COND extends StructureFieldOrder {
        public int dwSize;
        public int dwChannel;
    ...
    //字符叠加每一条信息结构体
    public static class NET_ITS_OVERLAP_SINGLE_ITEM_PARAM_V50 extends StructureFieldOrder {
        public byte[] byRes1 = new byte[2];                   // 保留
    ...
    public static class NET_ITS_OVERLAP_ITEM_PARAM_V50 extends StructureFieldOrder {
    ...
    //叠加项具体信息
    public static class NET_ITS_OVERLAP_INFO_PARAM extends StructureFieldOrder {
    ...
    public static class NET_ITS_OVERLAP_CFG_V50 extends StructureFieldOrder {
        public int dwSize;
        public byte byEnable; //是否启用，0-不启用，1-启用
        public byte[] byRes1 = new byte[3];
    ...
    //人体特征识别结果结构体
    public static class NET_VCA_HUMAN_FEATURE extends StructureFieldOrder {
    ...
    //人脸抓拍附加信息结构体
    public static class NET_VCA_FACESNAP_ADDINFO extends StructureFieldOrder {
    ...
    //人脸抓拍结果
    public static class NET_VCA_FACESNAP_RESULT extends StructureFieldOrder {
        public int dwSize;             // 结构大小
        public int dwRelativeTime;     // 相对时标
        public int dwAbsTime;            // 绝对时标
    ...
    //人脸抓拍信息
    public static class NET_VCA_FACESNAP_INFO_ALARM extends StructureFieldOrder {
        public int dwRelativeTime;     // 相对时标
        public int dwAbsTime;            // 绝对时标
    ...
    //籍贯参数
    public static class NET_DVR_AREAINFOCFG extends StructureFieldOrder {
    ...
    public static class NET_VCA_HUMAN_ATTRIBUTE extends StructureFieldOrder {
    ...
    //禁止名单报警信息
    public static class NET_VCA_BLOCKLIST_INFO_ALARM extends StructureFieldOrder {
    ...
    //禁止名单信息
    public static class NET_VCA_BLOCKLIST_INFO extends StructureFieldOrder {
        public int dwSize;   //结构大小
    ...
    //禁止名单比对结果报警上传
    public static class NET_VCA_FACESNAP_MATCH_ALARM extends StructureFieldOrder {
        public int dwSize;             // 结构大小
    ...
    //交通事件报警(扩展)
    public static class NET_DVR_AID_ALARM_V41 extends StructureFieldOrder {
        public int dwSize;              //结构长度
        public int dwRelativeTime;        //相对时标
        public int dwAbsTime;            //绝对时标
        public NET_VCA_DEV_INFO struDevInfo = new NET_VCA_DEV_INFO();            //前端设备信息
    ...
    //交通统计信息报警(扩展)
    public static class NET_DVR_TPS_ALARM_V41 extends StructureFieldOrder {
        public int dwSize;          // 结构体大小
        public int dwRelativeTime;  // 相对时标
        public int dwAbsTime;       // 绝对时标
    ...
    public static class NET_DVR_LANE_PARAM_V41 extends StructureFieldOrder {
    ...
    public static class NET_DVR_TPS_INFO_V41 extends StructureFieldOrder {
    ...
    // 车道队列结构体
    public static class NET_DVR_LANE_QUEUE extends StructureFieldOrder {
    ...
    //TPS统计过车数据上传
    public static class NET_DVR_TPS_STATISTICS_INFO extends StructureFieldOrder {
        public int dwSize;          // 结构体大小
    ...
    // 交通参数统计信息
    public static class NET_DVR_TPS_STATISTICS_PARAM extends StructureFieldOrder {
    ...
    //统计信息
    public static class NET_DVR_TPS_LANE_PARAM extends StructureFieldOrder {
    ...
    //TPS实时过车数据上传
    public static class NET_DVR_TPS_REAL_TIME_INFO extends StructureFieldOrder {
        public int dwSize;          // 结构体大小
        public int dwChan;//通道号
    ...
    //实时信息
    public static class NET_DVR_TPS_PARAM extends StructureFieldOrder {
        public byte byStart;          // 开始码
    ...
    public static class NET_DVR_TIME_SEARCH_COND extends StructureFieldOrder {
        public short wYear; //年
        public byte byMonth; //月
        public byte byDay; //日
        public byte byHour; //时
    ...
    //事件搜索条件
    public static class NET_DVR_SEARCH_EVENT_PARAM extends StructureFieldOrder {
    ...
    //审讯事件搜索条件
    public static class EVENT_INQUESTPARAM extends StructureFieldOrder {
    ...
    //事件搜索条件
    public static class NET_DVR_SEARCH_EVENT_PARAM_V50 extends StructureFieldOrder {
        public short wMajorType;            //0-移动侦测，1-报警输入, 2-智能事件 5-pos录像 7-门禁事件, 8-非视频联动事件
        public short wMinorType;            //搜索次类型- 根据主类型变化，0xffff表示全部
    ...
    public static class EVENT_ALARMPARAM_V50 extends StructureFieldOrder {
    ...
    //移动侦测
    public static class EVENT_MOTIONPARAM_V50 extends StructureFieldOrder {
    ...
    //行为分析
    public static class EVENT_VCAPARAM_V50 extends StructureFieldOrder {
    ...
    //审讯事件搜索条件
    public static class EVENT_INQUESTPARAM_V50 extends StructureFieldOrder {
        public byte byRoomIndex;    //审讯室编号,从1开始
        public byte[] byRes = new byte[799];     //保留
    }

    //智能侦测查找条件 ，通道号按值表示
    public static class EVENT_VCADETECTPARAM_V50 extends StructureFieldOrder {
    ...
    public static class EVENT_STREAMIDPARAM_V50 extends StructureFieldOrder {
    ...
    //pos录像
    public static class EVENT_POSPARAM_V50 extends StructureFieldOrder {
    ...
    public static class EVENT_TRIALPARAM_V50 extends StructureFieldOrder {
    ...
    //门禁事件搜索条件
    public static class EVENT_ACSPARAM_V50 extends StructureFieldOrder {
    ...
    //非视频联动事件搜索条件
    public static class EVENT_IOTPARAM_V50 extends StructureFieldOrder {
    ...
    //查找返回结果
    public static class NET_DVR_SEARCH_EVENT_RET extends StructureFieldOrder {
    ...
    //报警输入结果
    public static class EVENT_ALARMSTRET extends StructureFieldOrder {
    ...
    //审讯事件
    public static class EVENT_INQUESTRET extends StructureFieldOrder {
        public byte byRoomIndex;     //审讯室编号,从1开始
    ...
    //查找返回结果
    public static class NET_DVR_SEARCH_EVENT_RET_V50 extends StructureFieldOrder {
        public short wMajorType;            //主类型
        public short wMinorType;            //次类型
    ...
    //报警输入结果
    public static class EVENT_ALARMRET_V50 extends StructureFieldOrder {
        public int dwAlarmInNo;     //报警输入号
        public byte[] byRes = new byte[796];
    }

    //移动侦测结果
    public static class EVENT_MOTIONRET_V50 extends StructureFieldOrder {
        public int dwMotDetNo;    //移动侦测通道
        public byte[] byRes = new byte[796];
    }

    //行为分析结果
    public static class EVENT_VCARET_V50 extends StructureFieldOrder {
    ...
    //审讯事件
    public static class EVENT_INQUESTRET_V50 extends StructureFieldOrder {
        public byte byRoomIndex;     //审讯室编号,从1开始
        public byte byDriveIndex;    //刻录机编号,从1开始
        public byte[] byRes1 = new byte[6];       //保留
        public int dwSegmentNo;     //本片断在本次审讯中的序号,从1开始
    ...
    //流id录像查询结果
    public static class EVENT_STREAMIDRET_V50 extends StructureFieldOrder {
    ...
    //POS录像查询结果
    public static class EVENT_POSRET_V50 extends StructureFieldOrder {
        public int dwChanNo;        //触发产生pos事件的通道
        public byte[] byRes = new byte[796];
    }

    public static class EVENT_TRIALRET_V50 extends StructureFieldOrder {
        public byte byRoomIndex;     //审讯室编号,从1开始
        public byte byDriveIndex;    //刻录机编号,从1开始
        public short wSegmetSize;     //本片断的大小, 单位M
        public int dwSegmentNo;    //本片断在本次审讯中的序号,从1开始
    ...
    //非视频通道查询结果
    public static class EVENT_IOTRET_V50 extends StructureFieldOrder {
        public int dwChanNo;        //触发产生事件的通道号（事件源通道）
        public byte[] byRes = new byte[796];
    }

    public static class NET_DVR_INQUEST_RESUME_SEGMENT extends StructureFieldOrder {
    ...
    public static class NET_DVR_INQUEST_RESUME_EVENT extends StructureFieldOrder {
    ...
    //报警信息查询条件结构体
    public static class NET_DVR_ALARM_SEARCH_COND extends StructureFieldOrder {
        public int dwSize;
    ...
    //报警信息查询结果结构体
    public static class NET_DVR_ALARM_SEARCH_RESULT extends StructureFieldOrder {
        public int dwSize;
        /*
  	报警命令，该字段值与报警布防类型相同，目前支持：
  	COMM_VCA_ALARM 	0x4993    智能检测报警
    ...
    public static class NET_DVR_ALARM_ISAPI_INFO extends StructureFieldOrder {
    ...
    public static class NET_DVR_LOCAL_GENERAL_CFG extends StructureFieldOrder {
    ...
    public static class NET_DVR_LOCAL_TCP_PORT_BIND_CFG extends StructureFieldOrder {
    ...
    public static class NET_DVR_LOCAL_CHECK_DEV extends StructureFieldOrder {
    ...
    public static class NET_DVR_ALARM_ISAPI_PICDATA extends StructureFieldOrder {
        public int dwPicLen;
    ...
    public static class NET_DVR_FOCUSMODE_CFG extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_SERIALSTART_V40 extends StructureFieldOrder {
        public int dwSize;         //结构体大小
    ...
    //Sensor信息
    public static class NET_DVR_SENSOR_PARAM extends StructureFieldOrder {
    ...
    //球机位置信息
    public static class NET_DVR_PTZPOS_PARAM extends StructureFieldOrder {
    ...
    public static class NET_DVR_LLI_PARAM extends StructureFieldOrder {
    ...
    //GIS信息上传
    public static class NET_DVR_GIS_UPLOADINFO extends StructureFieldOrder {
        public int dwSize;//结构体大小
        public int dwRelativeTime; //相对时标
        public int dwAbsTime; //绝对时标
    ...
    public static class NET_DVR_DAYTIME extends StructureFieldOrder {
    ...
    public static class NET_DVR_SCHEDULE_DAYTIME extends StructureFieldOrder {
        public NET_DVR_DAYTIME struStartTime; //开始时间
        public NET_DVR_DAYTIME struStopTime; //结束时间
    }

    public static class NET_DVR_BUILTIN_SUPPLEMENTLIGHT extends StructureFieldOrder {
        public int dwSize;//结构体大小
    ...
    public static class NET_DVR_HANDLEEXCEPTION_V41 extends StructureFieldOrder {
        public int dwHandleType;        //异常处理,异常处理方式的"或"结果
        /*0x00: 无响应*/
        /*0x01: 监视器上警告*/
        /*0x02: 声音警告*/
    ...
    public static class NET_DVR_FACELIB_GUARD_COND extends StructureFieldOrder {
        public int dwSize;
        public int dwChannel;  //通道号
    ...
    //导入人脸数据条件
    public static class NET_DVR_FACELIB_COND extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_SEND_PARAM_IN extends StructureFieldOrder {
    ...
    public static class NET_DVR_INQUEST_ROOM extends StructureFieldOrder {
        public byte byRoomIndex;     //审讯室编号
        public byte byFileType;        //0-审讯文件，1-开庭上传文件
        public byte[] byRes = new byte[22];       //保留
    }

    public static class NET_DVR_INQUEST_CDRW_CFG extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_INQUEST_CDRW_STATUS extends StructureFieldOrder {
        /*运行状态：0-审讯开始，
     1-审讯过程中刻录，2-审讯停止，
     3-刻录审讯文件,
     4-备份(事后备份和本地备份)
    ...
    public static class NET_DVR_INQUEST_CDRW extends StructureFieldOrder {
    ...
    //实时温度检测条件参数
    public static class NET_DVR_REALTIME_THERMOMETRY_COND extends StructureFieldOrder {
        public int dwSize; /*结构体大小*/
    ...
    //点测温实时信息
    public static class NET_DVR_POINT_THERM_CFG extends StructureFieldOrder {
    ...
    //框/线测温实时信息
    public static class NET_DVR_LINEPOLYGON_THERM_CFG extends StructureFieldOrder {
    ...
    //实时温度信息
    public static class NET_DVR_THERMOMETRY_UPLOAD extends StructureFieldOrder {
        public int dwSize; /* 结构体大小 */
        public int dwRelativeTime;
        public int dwAbsTime;
    ...
    public static class NET_PTZ_INFO extends StructureFieldOrder {
        public float fPan;
        public float fTilt;
        public float fZoom;
    ...
    //测温模式配置
    public static class NET_DVR_THERMOMETRY_MODE extends StructureFieldOrder {
        public int dwSize;//结构体大小
    ...
    public static class NET_DVR_THERMOMETRY_COND extends StructureFieldOrder {
        public int dwSize;//结构体大小
        public int dwChannel;
    ...
    public static class NET_DVR_THERMOMETRY_PRESETINFO_PARAM extends StructureFieldOrder {
    ...
    public static class NET_DVR_THERMOMETRY_PRESETINFO extends StructureFieldOrder {
        public int dwSize;//结构体大小
        public short wPresetNo;//0-保留
        public byte[] byRes = new byte[2];
    ...
    //温度报警（检测温度和配置温度比较报警）
    public static class NET_DVR_THERMOMETRY_ALARM extends StructureFieldOrder {
        public int dwSize;
        public int dwChannel;//通道号
        public byte byRuleID;//规则ID
        public byte byThermometryUnit;//测温单位: 0-摄氏度（℃），1-华氏度（℉），2-开尔文(K)
    ...
    //温差报警
    public static class NET_DVR_THERMOMETRY_DIFF_ALARM extends StructureFieldOrder {
        public int dwSize;
        public int dwChannel;//通道号
    ...
    //船只检测报警上传
    public static class NET_DVR_SHIPSDETECTION_ALARM extends StructureFieldOrder {
        public int dwSize;
    ...
    //船只信息
    public static class NET_DVR_SHIPSINFO extends StructureFieldOrder {
    ...
    public static class NET_DVR_ARRAY_LIST extends StructureFieldOrder {
        public int dwSize;     // 结构体大小
        public int dwCount;    // 阵列个数
        public NET_DVR_ARRAY_INFO[] struArrayInfo = new NET_DVR_ARRAY_INFO[SUPPORT_ARRAY_NUM];
    }

    public static class NET_DVR_BGA_INFO extends StructureFieldOrder {
    ...
    // 阵列信息
    public static class NET_DVR_ARRAY_INFO extends StructureFieldOrder {
    ...
    //物理磁盘
    public static class NET_DVR_PHY_DISK_INFO extends StructureFieldOrder {
    ...
    public static class NET_DVR_WORKSTATE_V40 extends StructureFieldOrder {
        public int dwSize;            //结构体大小
        public int dwDeviceStatic;      //设备的状态,0-正常,1-CPU占用率太高,超过85%,2-硬件错误,例如串口死掉
    ...
    public static class NET_DVR_GETWORKSTATE_COND extends StructureFieldOrder {
    ...
    //多边型结构体
    public static class NET_ITC_POLYGON extends StructureFieldOrder {
    ...
    public static class NET_ITC_PLATE_RECOG_REGION_PARAM extends StructureFieldOrder {
    ...
    //单组IO测速参数
    public static class NET_ITC_SINGLE_IOSPEED_PARAM extends StructureFieldOrder {
        public byte byEnable; //是否启用，0-不启用，1-启用
    ...
    //牌识参数
    public static class NET_ITC_PLATE_RECOG_PARAM extends StructureFieldOrder {
    ...
    //卡口IO测速参数
    public static class NET_ITC_POST_IOSPEED_PARAM extends StructureFieldOrder {
    ...
    public static class NET_DVR_GEOGLOCATION extends StructureFieldOrder {
        public int[] iRes = new int[2]; /*保留*/
        public int dwCity; /*城市，详见PROVINCE_CITY_IDX */
    }

    public static class NET_ITC_INTERVAL_PARAM extends StructureFieldOrder {
        public byte byIntervalType;    //间隔类型（默认按时间），0-时间起效,1-距离起效
        public byte[] byRes1 = new byte[3];
    ...
    public static class NET_ITC_VTLANE_PARAM extends StructureFieldOrder {
        public byte byRelatedDriveWay;//关联的车道号
        public byte bySpeedCapEn; //是否启用超速抓拍，0-否，1-是
    ...
    public static class NET_ITC_VTCOIL_INFO extends StructureFieldOrder {
    ...
    public static class NET_ITC_RADAR_PARAM extends StructureFieldOrder {
    ...
    //卡口虚拟线圈触发参数
    public static class NET_ITC_POST_VTCOIL_PARAM extends StructureFieldOrder {
    ...
    //车道属性参数结构
    public static class NET_ITC_LANE_LOGIC_PARAM extends StructureFieldOrder {
        public byte byUseageType;     //车道用途类型，详见ITC_LANE_USEAGE_TYPE
    ...
    //视频电警线结构
    public static class NET_ITC_LINE extends StructureFieldOrder {
        public NET_VCA_LINE struLine = new NET_VCA_LINE(); //线参数
        public byte byLineType; //线类型，详见ITC_LINE_TYPE
        public byte[] byRes = new byte[7];
    }

    public static class NET_ITC_SNAPMODE_PARAM extends StructureFieldOrder {
    ...
    //size = 128
    public static class NET_ITC_HVT_EC_PARAM extends StructureFieldOrder {
    ...
    public static class NET_ITC_LANE_HVT_PARAM extends StructureFieldOrder {
    ...
    public static class NET_ITC_POST_HVT_PARAM extends StructureFieldOrder {
    ...
    //抓拍机4.0新增
    public static class NET_ITC_LANE_HVT_PARAM_V50 extends StructureFieldOrder {
    ...
    public static class NET_ITC_POST_HVT_PARAM_V50 extends StructureFieldOrder {
        public byte byLaneNum;    //识别的车道个数，1-6
    ...
    public static class NET_ITC_LANE_PARAM extends StructureFieldOrder {
    ...
    //卡口RS485车检器触发参数
    public static class NET_ITC_POST_RS485_PARAM extends StructureFieldOrder {
        public byte byRelatedLaneNum;//关联的车道个数
    ...
    //卡口RS485雷达触发参数
    public static class NET_ITC_POST_RS485_RADAR_PARAM extends StructureFieldOrder {
        public byte byRelatedLaneNum;//关联的车道个数
        public byte[] byRes1 = new byte[3];
        public NET_ITC_PLATE_RECOG_PARAM struPlateRecog = new NET_ITC_PLATE_RECOG_PARAM(); //牌识参数
        public NET_ITC_LANE_PARAM[] struLane = new NET_ITC_LANE_PARAM[MAX_ITC_LANE_NUM]; //关联的车道参数
    ...
    //单个触发参数结构
    public static class NET_ITC_SINGLE_TRIGGERCFG extends StructureFieldOrder {
    ...
    //触发参数结构
    public static class NET_ITC_TRIGGERCFG extends StructureFieldOrder {
        public int dwSize;            //结构长度
    ...
    //单个IO接入信号灯参数
    public static class NET_ITC_SINGLE_IO_LIGHT_PARAM extends StructureFieldOrder {
    ...
    //IO接入信号灯参数
    public static class NET_ITC_IO_LIGHT_PARAM extends StructureFieldOrder {
        public NET_ITC_SINGLE_IO_LIGHT_PARAM[] struIOLight = new NET_ITC_SINGLE_IO_LIGHT_PARAM[MAX_LIGHT_NUM]; //单个IO接入信号灯参数
        public byte[] byRes = new byte[8];
    }

    //单个485接入信号灯参数
    public static class NET_ITC_SINGLE_RS485_LIGHT_PARAM extends StructureFieldOrder {
        public byte byLightType; //交通灯导向类型，0-左转灯，1-直行灯，2-右转灯
    ...
    //485接入信号灯参数
    public static class NET_ITC_RS485_LIGHT_PARAM extends StructureFieldOrder {
        public NET_ITC_SINGLE_RS485_LIGHT_PARAM[] struRS485Light = new NET_ITC_SINGLE_RS485_LIGHT_PARAM[MAX_LIGHT_NUM]; //单个485接入信号灯参数
        public byte[] byRes = new byte[8];
    }

    public static class NET_POS_PARAM extends StructureFieldOrder {
        public short wLeft;
        public short wTop;
        public short wRight;
    ...
    //单组视频检测交通信号灯参数结构
    public static class NET_ITC_SINGLE_VIDEO_DETECT_LIGHT_PARAM extends StructureFieldOrder {
    ...
    public static class NET_ITC_VIDEO_DETECT_LIGHT_PARAM extends StructureFieldOrder {
    ...
    //交通信号灯参数结构
    public static class NET_ITC_TRAFFIC_LIGHT_PARAM extends StructureFieldOrder {
    ...
    //违规检测参数结构
    public static class NET_ITC_VIOLATION_DETECT_PARAM extends StructureFieldOrder {
    ...
    //违规检测线参数结构
    public static class NET_ITC_VIOLATION_DETECT_LINE extends StructureFieldOrder {
    ...
    //单个车道视频电警触发参数结构
    public static class NET_ITC_LANE_VIDEO_EPOLICE_PARAM extends StructureFieldOrder {
    ...
    //视频电警触发参数结构
    public static class NET_ITC_VIDEO_EPOLICE_PARAM extends StructureFieldOrder {
        public byte byEnable;    //是否启用，0-不启用，1-启用
    ...
    public static class NET_DVR_CURTRIGGERMODE extends StructureFieldOrder {
        public int dwSize;
        public int dwTriggerType; //触发类型，详见ITC_TRIGGERMODE_TYPE
        public byte[] byRes = new byte[24];
    }

    public static class NET_ITC_VIDEO_TRIGGER_COND extends StructureFieldOrder {
        public int dwSize;
        public int dwChannel;
    ...
    public static class NET_ITC_VIDEO_TRIGGER_PARAM extends StructureFieldOrder {
        public int dwSize;
    ...
    public static class NET_DVR_CMS_PARAM extends StructureFieldOrder {
        public int dwSize;
    ...
    //设置完全获取出厂值
    public static class NET_DVR_COMPLETE_RESTORE_INFO extends StructureFieldOrder {
        public int dwSize; //结构体长度
        public int dwChannel; //通道号
        public byte[] byRes = new byte[64];
    }

    public static class NET_DVR_STD_ABILITY extends StructureFieldOrder {
    ...
    public static class NET_DVR_STD_CONFIG extends StructureFieldOrder {
    ...
    public static class NET_DVR_LOCAL_SDK_PATH extends StructureFieldOrder {
        public byte[] sPath = new byte[NET_SDK_MAX_FILE_PATH];//组件库地址
        public byte[] byRes = new byte[128];
    }

    public static class BYTE_ARRAY extends StructureFieldOrder {
        public byte[] byValue;
    ...
    public static class INT_ARRAY extends StructureFieldOrder {
        public int[] intValue;
    ...
    public static class NET_DVR_JSON_DATA_CFG extends StructureFieldOrder {
        public int dwSize;                        //结构体大小
    ...
    public static class CallBack_USER extends StructureFieldOrder {
    ...
    public static class NET_DVR_CAMERAPARAMCFG_EX extends StructureFieldOrder {
        public int dwSize;
    ...
    */
    ...
    public static class NET_DVR_VIDEOEFFECT extends StructureFieldOrder {
    ...
    public static class NET_DVR_GAIN extends StructureFieldOrder {
    ...
    public static class NET_DVR_WHITEBALANCE extends StructureFieldOrder {
...
14-白炽灯 (IncandescentLamp)，15-暖光灯(Warm Light Lamp)，16-自然光(Natural Light) */
    ...
    public static class NET_DVR_EXPOSURE extends StructureFieldOrder {
    ...
    public static class NET_DVR_GAMMACORRECT extends StructureFieldOrder {
    ...
    public static class NET_DVR_WDR extends StructureFieldOrder {
    ...
    public static class NET_DVR_DAYNIGHT extends StructureFieldOrder {
    ...
    public static class NET_DVR_BACKLIGHT extends StructureFieldOrder {
    ...
    public static class NET_DVR_NOISEREMOVE extends StructureFieldOrder {
    ...
    public static class NET_DVR_CMOSMODECFG extends StructureFieldOrder {
    ...
    public static class NET_DVR_DEFOGCFG extends StructureFieldOrder {
        public byte byMode; //模式，0-不启用，1-自动模式，2-常开模式
        public byte byLevel; //等级，0-100
        public byte[] byRes = new byte[6];
    }

    public static class NET_DVR_CMOSMODCFG extends StructureFieldOrder {
        public byte byCaptureMod;   //抓拍模式：0-抓拍模式1；1-抓拍模式2
        public byte byBrightnessGate;//亮度阈值
        public byte byCaptureGain1;   //抓拍增益1,0-100
        public byte byCaptureGain2;   //抓拍增益2,0-100
    ...
    public static class NET_DVR_ELECTRONICSTABILIZATION extends StructureFieldOrder {
        public byte byEnable;//使能 0- 不启用，1- 启用
        public byte byLevel; //等级，0-100
        public byte[] byRes = new byte[6];
    }

    public static class NET_DVR_CORRIDOR_MODE_CCD extends StructureFieldOrder {
        public byte byEnableCorridorMode; //是否启用走廊模式 0～不启用， 1～启用
        public byte[] byRes = new byte[11];
    }

    public static class NET_DVR_SMARTIR_PARAM extends StructureFieldOrder {
    ...
    public static class NET_DVR_PIRIS_PARAM extends StructureFieldOrder {
        public byte byMode;//0-自动，1-手动
        public byte byPIrisAperture;//红外光圈大小等级(等级,光圈大小正比例)level:1~100 默认:50（手动模式下增加）
        public byte[] byRes = new byte[6];
    }

    public static class NET_DVR_LASER_PARAM_CFG extends StructureFieldOrder {
    ...
    public static class NET_DVR_FFC_PARAM extends StructureFieldOrder {
    ...
    public static class NET_DVR_DDE_PARAM extends StructureFieldOrder {
    ...
    public static class NET_DVR_AGC_PARAM extends StructureFieldOrder {
    ...
    public static class NET_DVR_SNAP_CAMERAPARAMCFG extends StructureFieldOrder {
    ...
    public static class NET_DVR_OPTICAL_DEHAZE extends StructureFieldOrder {
        public byte byEnable; //0~不启用光学透雾，1~启用光学透雾
        public byte[] byRes = new byte[7];
    }

    public static class NET_DVR_THERMOMETRY_AGC extends StructureFieldOrder {
    ...
    public static class NET_DVR_CHECK_DEV_STATE extends StructureFieldOrder
    {
    ...
    public static class NET_DVR_FLOW_INFO extends StructureFieldOrder {
        public int  dwSize;             //结构大小
    ...
    public static class NET_DVR_AES_KEY_INFO extends StructureFieldOrder {
        public byte[]    sAESKey=new byte[16];        /*码流加密密钥*/
        public byte[]    byRes=new byte[64];          /*保留字节*/
    }


    public static class NET_DVR_ALARM_RS485CFG  extends StructureFieldOrder
    {
        public int   dwSize;                 // 结构体大小
    ...
    public static class NET_DVR_DISPLAYCFG extends StructureFieldOrder {
        public int     dwSize;
        public NET_DVR_DISPLAYPARAM[] struDisplayParam = new NET_DVR_DISPLAYPARAM[MAX_DISPLAY_NUM];
        public byte[]  byRes2 = new byte[128];
    }

    public static class NET_DVR_DISPLAYPARAM extends StructureFieldOrder {
        public int    dwDisplayNo;
        public byte   byDispChanType;
        public byte[] byRes = new byte[11];
    }
    public static class NET_DVR_VIDEOWALLDISPLAYPOSITION extends StructureFieldOrder
    {
        public int   dwSize;
        public byte    byEnable;
    ...
    //gps相关结构定义
    public static class TimeSegParam extends StructureFieldOrder {
        //GPS数据查找起始时间
        public NET_DVR_TIME struBeginTime;
        //GPS数据查找结束时间
        public NET_DVR_TIME struEndTime;
    ...
    //按时间点查询
    public static class TimePointParam extends StructureFieldOrder {
        //GPS数据查找时间点
    ...
    //gps查询参数定义
    public static class NET_DVR_GET_GPS_DATA_PARAM extends StructureFieldOrder {
    ...
    //gps数据结构定义
    public static class NET_DVR_GPS_INFO extends StructureFieldOrder {
    ...
    //gps返回数据结构定义
    public static class NET_DVR_GPS_DATA extends StructureFieldOrder {
    ...
    /**热成像相关*/
    //设备抓图附加全屏测温数据结构体
    public static class NET_DVR_JPEGPICTURE_WITH_APPENDDATA extends StructureFieldOrder {
        public int dwSize;
        public int dwChannel;//通道号
    ...
    public static class DATE_TIME extends StructureFieldOrder {
    ...
    //全屏测温数据解析
    public static class STREAM_RT_DATA_INFO_S extends StructureFieldOrder {
    ...
    public static class STREAM_FS_SUPPLE_INFO_TEMP extends StructureFieldOrder {
    ...
    public static class STREAM_FARME_INFO_TEMP extends StructureFieldOrder {
    ...
    //测温规则温度信息
    public static class NET_DVR_THERMOMETRYRULE_TEMPERATURE_INFO extends StructureFieldOrder {
        public float fMaxTemperature;
        public float fMinTemperature;
        public float fAverageTemperature;
        public NET_VCA_POINT struHighestPoint;
    ...
    public static class REMOTECONFIGSTATUS_THERMOMETRY extends StructureFieldOrder {
        public byte[] byStatus = new byte[4];
        public byte[] byErrorCode = new byte[4];
    }

    public static class NET_DVR_FIREDETECTION_ALARM extends StructureFieldOrder {
        public int dwSize; //结构体大小
        public int dwRelativeTime; //相对时标
        public int dwAbsTime; //绝对时标
        public NET_VCA_DEV_INFO struDevInfo; //前端设备信息
    ...
    //模块服务配置结构体
    public static class NET_DVR_DEVSERVER_CFG extends StructureFieldOrder {
        public int dwSize; //结构体大小
    ...
    public static class NET_DVR_UPLOAD_FILE_RET extends StructureFieldOrder {

        public byte[]  sUrl=new byte[MAX_UPLOADFILE_URL_LEN];   //url
        public byte[] byRes=new byte[260];
    }

    public static class NET_DVR_FLOW_TEST_PARAM extends StructureFieldOrder {
        public int  dwSize;              //结构大小
        public int   lCardIndex;         //网卡索引
        public int  dwInterval;         //设备上传流量时间间隔, 单位:100ms
        public byte[] byRes=new byte[8];           //保留字节
    }
    public static class NET_DVR_RECORD_TIME_SPAN_INQUIRY extends StructureFieldOrder
    ...
    public static class NET_DVR_RECORD_TIME_SPAN extends StructureFieldOrder
    {
        public int           dwSize;        //结构体大小
    ...
    public static class NET_DVR_RECORD_CHECK_COND extends StructureFieldOrder {
        public int      dwSize;			                /* 结构大小 */
    ...
    public static class NET_DVR_RECORD_CHECK_RET extends StructureFieldOrder {
        public int      dwSize;			                /* 结构大小 */
     ...
     * 月历录像分布查询条件结构体
     */
    public static class NET_DVR_MRD_SEARCH_PARAM extends StructureFieldOrder {
        public int                dwSize;            // 结构体大小
     ...
     * 月历录像分布查询结果结构体
     */
    public static class NET_DVR_MRD_SEARCH_RESULT extends StructureFieldOrder {
    ...
    public static class NET_DVR_GIS_INFO extends StructureFieldOrder {
        public int dwSize;
    ...
    //GBT28181协议的设备编码通道配置
    public static class NET_DVR_GBT28181_CHANINFO_CFG extends StructureFieldOrder
    {
        public int                   dwSize;
    ...
    // 巡航路径配置条件结构体
    public static class NET_DVR_CRUISEPOINT_COND extends StructureFieldOrder {
        public int dwSize;
        public int dwChan;
    ...
    // 巡航路径配置结构体
    public static class NET_DVR_CRUISEPOINT_V40 extends StructureFieldOrder {
        public int dwSize;
    ...
    // 巡航路径配置结构体
    public static class NET_DVR_CRUISEPOINT_V50 extends StructureFieldOrder {
        public int dwSize;
        public NET_DVR_CRUISEPOINT_PARAM[] struCruisePoint =(NET_DVR_CRUISEPOINT_PARAM[])new NET_DVR_CRUISEPOINT_PARAM().toArray(256);
        public byte[] byRes = new byte[64];
    }
    // 巡航点参数结构体
    public static class NET_DVR_CRUISEPOINT_PARAM extends StructureFieldOrder {
        public short wPresetNo;
        public short wDwell;
        public byte bySpeed;
