package com.yjh.gateway.datasource;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.yjh.gateway.module.*.dao"}, sqlSessionTemplateRef = "baseSqlSessionTemplate")
public class ManageDataSourceConfig {
    ...
    @Value("${spring.datasource.gateway.password}")
