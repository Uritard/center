...
import com.yjh.video.core.gb28181.bean.msg.*;
 ...
 */
@Component
public class RedisGbPlayMsgHandler {
    private final static Logger logger = LoggerFactory.getLogger(RedisGbPlayMsgHandler.class);
