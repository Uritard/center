...
import com.yjh.video.core.gb28181.bean.msg.RequestPushStreamMsg;
...
public class AckRequestProcessor extends SIPRequestProcessorParent implements InitializingBean, ISIPRequestProcessor {
	...
	public void process(RequestEvent evt) {
		...
		if (mediaInfo == null) {
			...
			redisGbPlayMsgHandler.sendMsgForStartSendRtpStream(sendRtpItem.getServerId(), requestPushStreamMsg, jsonObject->{
