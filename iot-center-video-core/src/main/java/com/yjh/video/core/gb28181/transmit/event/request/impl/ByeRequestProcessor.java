...
import com.yjh.video.core.gb28181.transmit.event.request.impl.message.response.ResponseMessageHandler;
...
import com.yjh.video.core.gb28181.transmit.cmd.ISIPCommanderForPlatform;
			...
			if (sendRtpItem != null){
				...
				if (totalReaderCount <= 0) {
					...
					if (sendRtpItem.getPlayType().equals(InviteStreamType.PLAY)) {
						Device device = redisCatchStorage.getDevice(sendRtpItem.getDeviceId());
						if (device == null) {
