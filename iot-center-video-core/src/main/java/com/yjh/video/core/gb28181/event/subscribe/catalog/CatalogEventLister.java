package com.yjh.video.core.gb28181.event.subscribe.catalog;

import com.yjh.video.core.gb28181.bean.*;
import com.yjh.video.core.gb28181.transmit.cmd.impl.SIPCommanderFroPlatform;
import com.yjh.video.core.service.IGbStreamEventService;
...
public class CatalogEventLister implements ApplicationListener<CatalogEvent> {
    ...
    @Autowired
    private IGbStreamEventService gbStreamService;
