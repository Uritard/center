package com.yjh.video.core.utils;
...
public class DateUtil {
    ...
    public static boolean expire(String datetime, int expires){
        return expire(DateUtil.formatter.parse(datetime), expires);
    }

    public static boolean expire(TemporalAccessor datetime, int expires){
        Instant registerTimeDate = Instant.from(datetime);
        Instant expireInstant = registerTimeDate.plusMillis(TimeUnit.SECONDS.toMillis(expires));
