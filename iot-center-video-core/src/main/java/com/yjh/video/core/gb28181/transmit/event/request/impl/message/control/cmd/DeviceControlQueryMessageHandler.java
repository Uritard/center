package com.yjh.video.core.gb28181.transmit.event.request.impl.message.control.cmd;
...
import com.yjh.video.core.gb28181.transmit.event.request.impl.message.control.ControlMessageHandler;
...
public class DeviceControlQueryMessageHandler extends SIPRequestProcessorParent implements InitializingBean, IMessageHandler {
    ...
    public void handForPlatform(RequestEvent evt, ParentPlatform parentPlatform, Element rootElement) {
        ...
        // 云台/前端控制命令
        if (!ObjectUtils.isEmpty(XmlUtil.getText(rootElement,"PTZCmd")) && !parentPlatform.getServerGBId().equals(targetGBId)) {
