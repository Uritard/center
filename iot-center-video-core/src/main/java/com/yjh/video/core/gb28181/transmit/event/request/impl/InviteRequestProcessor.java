package com.yjh.video.core.gb28181.transmit.event.request.impl;
...
import com.yjh.video.core.gb28181.transmit.SIPProcessorObserver;
import com.yjh.video.core.gb28181.transmit.cmd.ISIPCommander;
import com.yjh.video.core.gb28181.transmit.cmd.impl.SIPCommanderFroPlatform;
import com.yjh.video.core.gb28181.transmit.event.request.ISIPRequestProcessor;
import com.yjh.video.core.gb28181.transmit.event.request.SIPRequestProcessorParent;
import com.yjh.video.core.gb28181.transmit.redismsg.RedisGbPlayMsgHandler;
import com.yjh.video.core.gb28181.transmit.redismsg.RedisPushStreamResponseHandler;
import com.yjh.video.core.media.zlm.ZLMMediaListManager;
import com.yjh.video.core.media.zlm.ZLMRTPServerFactory;
import com.yjh.video.core.media.zlm.ZlmHttpHookSubscribe;
import com.yjh.video.core.media.zlm.dto.*;
import com.yjh.video.core.service.IMediaServerEventService;
import com.yjh.video.core.service.IPlayService;
import com.yjh.video.core.service.IStreamProxyEventService;
import com.yjh.video.core.service.IStreamPushEventService;
import com.yjh.video.core.storager.IRedisCatchStorage;
import com.yjh.video.core.storager.IVideoManagerStorage;
import com.yjh.video.core.storager.bean.MessageForPushChannel;
import com.yjh.video.core.utils.DateUtil;
import com.yjh.video.core.utils.SipUtils;
...
public class InviteRequestProcessor extends SIPRequestProcessorParent implements InitializingBean, ISIPRequestProcessor {
    ...
    @Autowired
    private IStreamPushEventService streamPushService;
    @Autowired
    private IStreamProxyEventService streamProxyService;
    ...
    @Autowired
    private RedisPushStreamResponseHandler redisPushStreamResponseHandler;
    ...
    @Autowired
    private RedisGbPlayMsgHandler redisGbPlayMsgHandler;
...
//                    }
    ...
    private void notifyStreamOnline(RequestEvent evt, ServerTransaction serverTransaction, GbStream gbStream, StreamPushItem streamPushItem, ParentPlatform platform,
        ...
        if ("proxy".equals(gbStream.getStreamType())) {
            ...
            // 添加回复的拒绝或者错误的通知
            redisPushStreamResponseHandler.addEvent(gbStream.getApp(), gbStream.getStream(), response -> {
    ...
    private void otherWvpPushStream(RequestEvent evt, ServerTransaction serverTransaction, GbStream gbStream, StreamPushItem streamPushItem, ParentPlatform platform,
        ...
        // 发送redis消息
        redisGbPlayMsgHandler.sendMsg(streamPushItem.getServerId(), streamPushItem.getMediaServerId(),
                ...
                channelId, mediaTransmissionTCP, null, responseSendItemMsg -> {
                    ...
                    try {
                        // 错误
                        if (wvpResult.getCode() == RedisGbPlayMsgHandler.ERROR_CODE_OFFLINE) {
                            // 离线
                            // 查询是否在本机上线了
