...
public class ChanResultXML {
    ...
    public static ChanResult unPackingXMl(String xml) throws DocumentException, ParseException {
        ...
        try {
            ...
            chanResult.setSignalResult(Integer.valueOf(childNode9.getText()));
            Element childNode10 = root.element("resultOfBlur");
            chanResult.setBlurResult(Integer.valueOf(childNode10.getText()));
            Element childNode11 = root.element("resultOfContrast");
            chanResult.setContrastResult(Integer.valueOf(childNode11.getText()));
            Element childNode12 = root.element("resultOfBright");
            chanResult.setBrightResult(Integer.valueOf(childNode12.getText()));
            Element childNode13 = root.element("resultOfDark");
            chanResult.setDarkResult(Integer.valueOf(childNode13.getText()));
            Element childNode14 = root.element("resultOfChroma");
            chanResult.setChromaResult(Integer.valueOf(childNode14.getText()));
            Element childNode15 = root.element("resultOfMono");
            chanResult.setMonoResult(Integer.valueOf(childNode15.getText()));
            Element childNode16 = root.element("resultOfNoise");
            chanResult.setNoiseResult(Integer.valueOf(childNode16.getText()));
            Element childNode17 = root.element("resultOfStreak");
            chanResult.setStreakResult(Integer.valueOf(childNode17.getText()));
            Element childNode18 = root.element("resultOfFreeze");
            chanResult.setFreezeResult(Integer.valueOf(childNode18.getText()));
            Element childNode19 = root.element("resultOfShake");
            chanResult.setShakeResult(Integer.valueOf(childNode19.getText()));
            Element childNode20 = root.element("resultOfFlash");
            chanResult.setFlashResult(Integer.valueOf(childNode20.getText()));
            Element childNode21 = root.element("resultOfScene");
            chanResult.setSceneResult(Integer.valueOf(childNode21.getText()));
            Element childNode22 = root.element("resultOfCover");
            chanResult.setCoverResult(Integer.valueOf(childNode22.getText()));
            Element childNode23 = root.element("resultOfPTZ");
            chanResult.setPtzResult(Integer.valueOf(childNode23.getText()));
