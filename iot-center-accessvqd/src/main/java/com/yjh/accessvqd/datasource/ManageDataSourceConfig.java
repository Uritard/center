package com.yjh.accessvqd.datasource;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.yjh.accessvqd.module.*.dao"}, sqlSessionTemplateRef = "baseSqlSessionTemplate")
public class ManageDataSourceConfig {

    private Logger log = LoggerFactory.getLogger(ManageDataSourceConfig.class);

    @Value("${spring.datasource.accessvqd.publicKey}")
    private String publicKey;

    @Value("${spring.datasource.accessvqd.password}")
    private String password;

    @Bean(name = "baseDataSource")
    @ConfigurationProperties(prefix = "spring.datasource.accessvqd")
