...
public class NettyServer {
    ...
    public void start(InetSocketAddress address, ChanResultService chanResultService, RedisTemplate redisTemplate, TDiagnosePlanDao tDiagnosePlanDao){
        ...
        try {
            ...
            .childHandler(new VqdServerChannelInitializer(chanResultService, redisTemplate, tDiagnosePlanDao))
