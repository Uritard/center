...
public class NettyServer {
    ...
    public void start(InetSocketAddress address, RedisTemplate redisTemplate, RedisTemplate redisTemplate2){
        ...
        try {
            ...
            .childHandler(new IEC104ServerChannelInitializer(redisTemplate, redisTemplate2))
