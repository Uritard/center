package com.yjh.etl.datasource;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.yjh.device.module.*.dao"}, sqlSessionTemplateRef = "baseSqlSessionTemplate")
public class ManageDataSourceConfig {

    private Logger log = LoggerFactory.getLogger(ManageDataSourceConfig.class);

    @Value("${spring.datasource.device.publicKey}")
    private String publicKey;

    @Value("${spring.datasource.device.password}")
