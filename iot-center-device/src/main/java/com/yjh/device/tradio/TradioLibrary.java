...
public interface TradioLibrary extends Library {
    public static final String JNA_LIBRARY_NAME = "F:\\IotCenter\\iot-center-device\\src\\main\\resources\\lib\\TradioCp.dll";
     ...
     * @deprecated use the safer methods {@link #NET_TRADIO_DeviceReboot(java.lang.String, int)} and {@link #NET_TRADIO_DeviceReboot(com.sun.jna.Pointer, int)} instead
     */
    @Deprecated
     ...
     * @deprecated use the safer methods {@link #NET_TRADIO_TestDevice(java.lang.String, int, int, tradio.NET_TRADIO_DEVICEINFO)} and {@link #NET_TRADIO_TestDevice(com.sun.jna.Pointer, int, int, tradio.NET_TRADIO_DEVICEINFO)} instead
     */
    @Deprecated
