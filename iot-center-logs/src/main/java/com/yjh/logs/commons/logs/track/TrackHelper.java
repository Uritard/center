...
public interface TrackHelper {
    ...
    default void setRouteAttachment(String key, String value) {
    ...
    default String getRouteAttachment(String key) {
        return TRACK_LOCAL_THREAD.get().get(key);
    }

    default Map<String, String> getRouteAttachment() {
        return TRACK_LOCAL_THREAD.get();
    }

    default String removeRouteAttachment(String key) {
        String value = this.getRouteAttachment(key);
    ...
    default Map<String, String> removeRouteAttachment() {
        Map<String, String> attachment = null;
        try {
            attachment = this.getRouteAttachment();
    ...
    static void setCurrentTrackInfo(Map<String, String> attachment) {
        if (null != attachment && !attachment.isEmpty()) {
            TRACK_LOCAL_THREAD.get().putAll(attachment);
        }
    }
