package com.yjh.logs.datasource;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.yjh.logs.module.*.dao"}, sqlSessionTemplateRef = "baseSqlSessionTemplate")
public class ManageDataSourceConfig {

    private Logger log = LoggerFactory.getLogger(ManageDataSourceConfig.class);

    @Value("${spring.datasource.logs.publicKey}")
    private String publicKey;

    @Value("${spring.datasource.logs.password}")
