...
//    public static final String TABLES = "sys_menu,sys_role_menu";
    public static final String TABLES = "sys_logs";
    ...
    public static void main(String args[]) {
        ...
        String projectPath2 = "F:/workspace/jiejuefangan/IotCenter/iot-center-logs";
...
//        pc.setModuleName(scanner("请输入你的包名"));
        pc.setModuleName("tt");
        pc.setParent("com.yjh.logs.module");//你哪个父目录下创建包
