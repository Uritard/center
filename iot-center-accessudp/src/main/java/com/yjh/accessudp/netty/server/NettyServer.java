...
public class NettyServer {
    ...
    public void start(InetSocketAddress address, RedisTemplate redisTemplate, TCfgMeteService tCfgMeteService,String UNION_URL,String SEQUENCE_URL,String SEQUENCEREC_URL){
        ...
        try {
            ...
            .handler(new UDPServerChannelInitializer(redisTemplate, tCfgMeteService,UNION_URL, SEQUENCE_URL,SEQUENCEREC_URL));
