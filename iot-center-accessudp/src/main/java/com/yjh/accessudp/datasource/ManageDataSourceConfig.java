package com.yjh.accessudp.datasource;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.yjh.accessudp.module.*.dao"}, sqlSessionTemplateRef = "baseSqlSessionTemplate")
public class ManageDataSourceConfig {

    private Logger log = LoggerFactory.getLogger(ManageDataSourceConfig.class);

    @Value("${spring.datasource.accessudp.publicKey}")
    private String publicKey;

    @Value("${spring.datasource.accessudp.password}")
    private String password;

    @Bean(name = "baseDataSource")
    @ConfigurationProperties(prefix = "spring.datasource.accessudp")
