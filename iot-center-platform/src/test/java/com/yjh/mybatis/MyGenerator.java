...
//    public static final String TABLES = "sys_menu,sys_role_menu";
    public static final String TABLES = "t_camera_preset";
    ...
    public static void main(String args[]) {
       ...
       // 全局配置
        ...
        String projectPath2 = "D:/MyDocuments/workspace_idea/IotCenterDev/IotCenter/iot-center-platform";
...
//        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/smartelectric?serverTimezone=GMT&useUnicode=true&useSSL=false&characterEncoding=utf8");
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/intelligenceelec?serverTimezone=GMT&useUnicode=true&useSSL=false&characterEncoding=utf8");
        dataSourceConfig.setDriverName("com.mysql.jdbc.Driver");
        dataSourceConfig.setUsername("root");
//        dataSourceConfig.setPassword("yjh@123!");
        dataSourceConfig.setPassword("666");
        //实体类输出类型转换
