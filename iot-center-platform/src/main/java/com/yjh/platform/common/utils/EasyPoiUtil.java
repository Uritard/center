...
public class EasyPoiUtil {
    ...
    * */
    public static void exportExcel(List<?> list,  String sheetName, String fileName,
                                   boolean isNeedSignature,String reportPath) {
        TemplateExportParams params = new TemplateExportParams();
        params.setSheetName(sheetName);// 设置sheetName
        params.setTemplateUrl("D:/MyDocuments/xls文档/reportTemplate.xlsx");
//            params.setTemplateUrl(reportPath+"/reportTemplate.xlsx");
        //获取报表内容
        Map<String, Object> data = new HashMap<>();
        data.put("list", list);
        Workbook workbook = ExcelExportUtil.exportExcel(params, data);
        try {
//                FileOutputStream fileOutputStream = new FileOutputStream(reportPath+"/"+fileName+".xlsx");
