...
public class VoiceAnalyseUtil {
    ...
    private String file,filePath,fileName;
...
//		setPreferredSize(new Dimension(width, height));
    ...
    public int getMaxVoice() {
        return max.stream().mapToInt(Integer::valueOf).max().getAsInt();
    }
    ...
    private void drawHistogram(float[] amp) {
        ...
        //log.info("本段-第"+(count++)+"段的分贝是"+listMax+"分贝");
        DBList.add(listMax);
...
//		}
    ...
    public List<Integer> analyticalDecibels() {
