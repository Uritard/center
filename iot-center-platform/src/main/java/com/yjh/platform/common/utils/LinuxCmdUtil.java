...
////
////    public LinuxCmdUtil(String ipAddr, String userName, String password, Charset charset) {
////        this.ipAddr = ipAddr;
...
////        LinuxCmdUtil tool = new LinuxCmdUtil("192.168.9.40", "root", "yijiahe", StandardCharsets.UTF_8);
////        StringBuilder exec = tool.exec("df -hl");
...
//
//            try {
//                Map<?, ?> map1 = LinuxCmdUtil.cpuinfo();
//                Thread.sleep(CPUTIME);
//                Map<?, ?> map2 = LinuxCmdUtil.cpuinfo();
//
...
//
//        double cpuUsage = LinuxCmdUtil .getCpuUsage();
////当前系统的内存使用率
//        double memUsage = LinuxCmdUtil .getMemUsage();
////当前系统的硬盘使用率
//        double diskUsage = LinuxCmdUtil .getDiskUsage();
//
