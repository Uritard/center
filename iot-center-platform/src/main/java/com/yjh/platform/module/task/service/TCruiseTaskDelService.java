...
public class TCruiseTaskDelService {
    ...
    @Logs(title = "分页查询", code = "TCruiseTaskDel",content = "根据web传入的参数查询")
    @Transactional(rollbackFor = Exception.class)
    ...
    @Logs(title = "批量插入", code = "TCruiseTaskDel",content = "根据web传入的参数批量插入")
    @Transactional(rollbackFor = Exception.class)
