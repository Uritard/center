...
public class TCfgTelesignalController {
    ...
    @Logs(title = "新增",content = "根据用户传递的参数插入遥信数据",logType = 2)
    ...
    @Logs(title = "删除",content = "根据用户传递的参数删除遥信数据",logType = 4)
    ...
    @Logs(title = "更新",content = "根据用户传递的参数修改遥信数据",logType = 3)
    ...
    @Logs(title = "查询",content = "根据用户传递的参数查询遥信数据",logType = 1)
    ...
    @Logs(title = "批量插入",content = "根据用户传递的参数批量插入遥信数据",logType = 2)
