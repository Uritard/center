...
public class TAlgorithmConfBakController {
    ...
    @Logs(title = "新增",content = "根据用户传递的参数新增算法配置信息",logType = 2)
    ...
    @Logs(title = "删除",content = "根据用户传递的参数删除算法配置信息",logType = 4)
    ...
    @Logs(title = "修改",content = "根据用户传递的参数更新算法配置数据",logType = 3)
    ...
    @Logs(title = "批量删除",content = "根据用户传递的参数批量删除算法配置信息",logType = 4)
    ...
    @Logs(title = "查询",content = "根据用户传递的参数查询已有的算法分析类型",logType = 1)
