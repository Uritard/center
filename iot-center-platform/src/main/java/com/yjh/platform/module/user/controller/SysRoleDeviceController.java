...
public class SysRoleDeviceController {
    ...
    @Logs(title = "新增",content = "根据用户传递的参数新增角色和设备关联数据",logType = 2)
    ...
    @Logs(title = "删除",content = "根据用户传递的参数删除角色和设备关联数据",logType = 4)
    ...
    @Logs(title = "修改",content = "根据用户传递的参数修改角色和设备关联数据",logType = 3)
    ...
    @Logs(title = "查询",content = "根据用户传递的参数查询角色和设备关联信息",logType = 1)
    ...
    @Logs(title = "查询",content = "根据用户传递的参数分页查询角色和设备关联信息",logType = 1)
    ...
    @Logs(title = "批量插入",content = "根据用户传递的参数批量插入角色和设备关联数据",logType = 2)
