...
public class TRobotAlarmController {
    ...
    @Logs(title = "查询",content = "根据用户传递的参数查询机器人本体告警信息",logType = 1)
    ...
    @Logs(title = "查询",content = "根据用户传递的参数分页查询机器人本体告警信息",logType = 1)
    ...
    @Logs(title = "批量插入",content = "根据用户传递的参数批量插入机器人本体告警数据",logType = 2)
