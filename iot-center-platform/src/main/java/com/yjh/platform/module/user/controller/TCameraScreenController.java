...
//            result.setData(tCameraScreenService.cameraStateTree(cameraName,flag));
              result.setData(tCameraScreenService.selectCameraTreeWithRobotNew(cameraName,flag, "1",userId,level,id, null, null));
        } catch (Exception e) {
            result.setCode(ResultCodeEnum.UPDATEERROR.getCode(), ResultCodeEnum.UPDATEERROR.getName());
            log.error("失败描述：", e);
        }
    ...
    public Result selectCameraTreeWithRobot(@RequestParam(value = "cameraName",required = false) String cameraName,
        ...
        try {
            Long userId = Long.valueOf(request.getHeader("userId"));
            result.setData(tCameraScreenService.selectCameraTreeWithRobotNew(cameraName, flag, null, userId, level, id, cameraType, useType));
        } catch (Exception e) {
            result.setCode(ResultCodeEnum.UPDATEERROR.getCode(), ResultCodeEnum.UPDATEERROR.getName());
            log.error("失败描述：", e);
        }
    ...
    public Result selectCameraTreeWithRobotByName(@RequestParam(value = "name",required = false) String name,
        ...
        try {
            Long userId=Long.valueOf(request.getHeader("userId"));
            result.setData(tCameraScreenService.selectCameraTreeWithRobotByName(name, flag, deviceType, userId, cameraType, useType));
        } catch (Exception e) {
            result.setCode(ResultCodeEnum.UPDATEERROR.getCode(), ResultCodeEnum.UPDATEERROR.getName());
            log.error("失败描述：", e);
        }
