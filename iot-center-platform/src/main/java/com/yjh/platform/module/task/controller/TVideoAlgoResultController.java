...
public class TVideoAlgoResultController {
    ...
    @Logs(title = "新增",content = "根据用户传递的参数新增视频轮训任务结果数据",logType = 2)
    ...
    @Logs(title = "删除",content = "根据用户传递的参数删除视频轮训任务结果数据",logType = 4)
    ...
    @Logs(title = "修改",content = "根据用户传递的参数修改视频轮训任务结果数据",logType = 3)
    public Result update(@RequestBody TVideoAlgoResult tVideoAlgoResult) {
        Result result = new Result();
        try {
    ...
    @Logs(title = "查询",content = "根据用户传递的参数查询视频轮训任务结果信息",logType = 1)
    ...
    @Logs(title = "查询",content = "根据用户传递的参数分页查询视频轮训任务结果信息",logType = 1)
