...
public class THisTelemeterDataController {
    ...
    public Result update(@Validated @RequestBody THisTelemeterData tHisTelemeterData) {
        Result result = new Result();
        try {
    ...
    @Logs(title = "查询遥测历史数据",content = "根据用户传递的参数分页查询信息",logType = 1,authority = "1234,1235")
