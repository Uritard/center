...
public interface UPatrolDataResultDao {
    ...
    int batchUpdateByTaskIdAndInstanceId(@Param(value = "list") List<UPatrolDataResult> list);
    ...
    Map<String, Object> selectWaitAndAbnormalByTaskId(@Param(value = "taskId") String taskId);
