...
public class TCruiseTaskResultDetailService{
    ...
    @Transactional(rollbackFor = Exception.class)
    public List<TCruiseTaskResultDetail> select(String cruiseResultId, String taskResultId, Long deviceId, Long cruiseId, Date cruiseTime, Date endTime, Integer cruiseStatus, String remark) {
        List<TCruiseTaskResultDetail> tCruiseTaskResultDetailList = tCruiseTaskResultDetailDao.select(cruiseResultId, taskResultId, deviceId, cruiseId, cruiseTime, endTime, cruiseStatus, remark);
