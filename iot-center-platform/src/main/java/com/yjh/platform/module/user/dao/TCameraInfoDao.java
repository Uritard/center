...
public interface TCameraInfoDao {
    ...
    List<TCameraInfoByDict> select(@Param(value = "cameraId") Long cameraId,
                            ...
                            @Param(value = "pmsId") String pmsId,
                             ...
                             @Param(value = "cameraNum") Integer cameraNum,
                             ...
                             @Param(value = "infreadPort") Integer infreadPort,
                             @Param(value = "cameraManager") String cameraManager,
                             @Param(value = "cameraCode") String cameraCode,
