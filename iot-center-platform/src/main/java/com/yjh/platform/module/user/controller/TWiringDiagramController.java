...
public class TWiringDiagramController {
    ...
    public Result insert(MultipartFile file,
        ...
        try {
            ...
            result = tWiringDiagramService.insert(file, regionId, regionName, userId, result,robotId,type);
    ...
    public Result selectByCondition(@RequestParam(value = "regionId", required = false) Long regionId,
        ...
        Result result = new Result();
        try {
            result.setData(tWiringDiagramService.selectByCondition(regionId, robotId,type));
        } catch (Exception e) {
            result.setCode(ResultCodeEnum.UPDATEERROR.getCode(), ResultCodeEnum.UPDATEERROR.getName());
