...
public class TUnionTaskController {
    ...
    public Result selectByPage(@RequestBody TUnionTask tUnionTask
        ...
        try {
            Page page = PageHelper.startPage(tUnionTask.getPageNum()!=null?tUnionTask.getPageNum():1, tUnionTask.getPageSize()!=null?tUnionTask.getPageSize():0,true,null,true);
    ...
    @Logs(title = "联动历史记录统计",content = "根据用户传递的参数统计联动历史记录",logType = 1,authority = "1234,1235")
