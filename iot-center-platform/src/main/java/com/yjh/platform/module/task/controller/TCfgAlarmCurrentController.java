...
public class TCfgAlarmCurrentController {
    ...
    public Result selectByPage(@RequestBody TCfgAlarmCurrent tCfgAlarmCurrent
        ...
        try {
            Page page = PageHelper.startPage(tCfgAlarmCurrent.getPageNum()!=null?tCfgAlarmCurrent.getPageNum():1, tCfgAlarmCurrent.getPageSize()!=null?tCfgAlarmCurrent.getPageSize():0,true,null,true);
