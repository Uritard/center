...
public interface TRobotInfoDao {
    ...
    //多表删除 t_cruise_plan u_patrol_plan_attr t_cruise_point_instance 删除操作票信息
    ...
    List<TRobotInfo> select(@Param(value = "robotId") Long robotId,
                            ...
                            @Param(value = "nestCode") String nestCode,
                            @Param(value = "nestName") String nestName,
    ...
    List<Long> selectAllEnvRegionId(List<Long> list);
