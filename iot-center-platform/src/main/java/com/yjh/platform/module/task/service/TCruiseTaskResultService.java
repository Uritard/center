...
public class TCruiseTaskResultService {
    ...
    public List<Map<String, Object>> selectCruiseTaskResult(String taskId) throws ParseException {
        ...
        //最终结果集容器
        log.info("开始时间=="+simpleDateFormat.format(new Date(System.currentTimeMillis())));
        ...
        log.info("时间节点2=="+simpleDateFormat.format(new Date(System.currentTimeMillis())));
        ...
        for (CruiseInspectResult cruiseInspectResult : cruiseInspectResults) {
            ...
            log.info("时间节点3=="+simpleDateFormat.format(new Date(System.currentTimeMillis())));
...
//        log.info("list!!!!!!!!!!!!!!!!!!" + cruiseInspectResults);
        ...
        log.info("结束时间=="+simpleDateFormat.format(new Date(System.currentTimeMillis())));
