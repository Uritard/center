...
public class TCruiseTypeController {
    ...
    @Logs(title = "删除巡视类型关联实例点数据",content = "根据用户传递的参数删除巡视类型关联实例点数据",logType = 4)
    ...
    @Logs(title = "查询巡视类型关联实例点数据",content = "根据用户传递的参数查询巡视类型关联实例点信息",logType = 1)
    ...
    @Logs(title = "批量插入巡视类型关联实例点数据",content = "根据用户传递的参数批量插入巡视类型关联实例点数据",logType = 2)
    ...
    @Logs(title = "批量删除巡视类型关联实例点数据",content = "根据用户传递的参数批量删除巡视类型关联实例点数据",logType = 4)
