...
(
    ...
    `cruise_name`           varchar(256) DEFAULT '' COMMENT '巡检点名称',
...
(
    ...
    `node_id`        bigint       DEFAULT NULL COMMENT '地图点Id',
    PRIMARY KEY (`device_id`) USING BTREE,
...
(
    ...
    `x_coordinate`      float(7, 3
) DEFAULT '0.000' COMMENT '坐标位置x',
...
(
    ...
    `model_config` json DEFAULT NULL COMMENT '首页模块配置',
    PRIMARY KEY (`id`) USING BTREE
