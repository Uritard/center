...
INSERT INTO `t_dict_business` (`dict_code`, `col_name`, `up_dict`, `remark`, `sort`) VALUES ('0','frequency','无','物联设备采集频率', 1);
INSERT INTO `t_dict_business` (`dict_code`, `col_name`, `up_dict`, `remark`, `sort`) VALUES ('5','frequency','5 分钟','物联设备采集频率', 2);
...
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('robotServerConfig', 'robot服务的配置', 'needConfirmSet', '1_5,1_6,20001_6,20001_7', '需要密码校验的巡视设备控制命令', '机器人远方复位1_1，机器人一键返航1_3，机器人控制模式切换1_5，机器人控制权获得1_6，机器人控制权释放1_7，机器人云台复位3_9，\r\n机器人红外热像仪重启22_8，机器人可见光摄像机重启21_8，无人机系统自检20001_2，无人机一键返航20001_3，无人机自动降落20001_4，\r\n无人机控制模式20001_5，无人机控制权获得20001_6，无人机控制权释放20001_7，无人机电源管理20001_8，无人机云台重置20003_5，\r\n机巢开关20005_1，机巢舱门开关20005_3', '{\"rule\":\"^[_a-zA-Z0-9,]+$\",\"msg\":\"请不要输入特殊字符\"}');
...
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('videoServerConfig', 'video服务的配置', 'ffmpeg-208', '/usr/local/bin/ffmpeg -rtsp_transport tcp -i rtsp://${username}:${password}@${ip}:${port}/cam/realmonitor?channel=${channelId}%26subtype=0 -vcodec copy -fflags nobuffer -an -f flv rtmp://${hostIp}/live/${name}', '大华拉流命令', '无', NULL);
