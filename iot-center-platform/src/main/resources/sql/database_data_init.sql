...
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('managerSystem', '算法管理平台配置', 'managerSystemFtpsPort', '10014', 'ftps服务端口', '算法管理平台ftps服务端口', '{\"rule\":\"^([0-9]|[1-9]\\\\d{1,3}|[1-5]\\\\d{4}|6[0-4]\\\\d{4}|65[0-4]\\\\d{2}|655[0-2]\\\\d|6553[0-5])$\",\"msg\":\"请输入正确端口\"}');
...
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('managerSystem', '算法管理平台配置', 'provinceName', '江苏', '省份', '消息内容基础配置', '{\"rule\":\"^[\\\\u4e00-\\\\u9fa5_a-zA-Z0-9\\\\-]+$\",\"msg\":\"请不要输入特殊字符\"}');
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('managerSystem', '算法管理平台配置', 'cityName', '南京', '城市', '消息内容基础配置', '{\"rule\":\"^[\\\\u4e00-\\\\u9fa5_a-zA-Z0-9\\\\-]+$\",\"msg\":\"请不要输入特殊字符\"}');
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('managerSystem', '算法管理平台配置', 'sectionId', '01', '区域编码', '消息内容基础配置', '{\"rule\":\"^[_a-zA-Z0-9\\\\-]+$\",\"msg\":\"请不要输入特殊字符\"}');
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('managerSystem', '算法管理平台配置', 'sectionName', '500kV江苏变电站区域', '区域名称', '消息内容基础配置', '{\"rule\":\"^[\\\\u4e00-\\\\u9fa5_a-zA-Z0-9\\\\-]+$\",\"msg\":\"请不要输入特殊字符\"}');
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('managerSystem', '算法管理平台配置', 'stationName', '500kV江苏变电站', '变电站名称', '消息内容基础配置', '{\"rule\":\"^[\\\\u4e00-\\\\u9fa5_a-zA-Z0-9\\\\-]+$\",\"msg\":\"请不要输入特殊字符\"}');
...
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('managerSystem', '算法管理平台配置', 'managerSystemIp', '192.168.9.40', '系统IP', '算法管理平台ip', '{\"rule\":\"^([1-9]?\\\\d|1\\\\d{2}|2[0-4]\\\\d|25[0-5])(\\\\.([1-9]?\\\\d|1\\\\d{2}|2[0-4]\\\\d|25[0-5])){3}$\",\"msg\":\"请输入正确的ip\"}');
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('managerSystem', '算法管理平台配置', 'managerSystemPort', '10013', '系统端口', '算法管理平端口', '{\"rule\":\"^([0-9]|[1-9]\\\\d{1,3}|[1-5]\\\\d{4}|6[0-4]\\\\d{4}|65[0-4]\\\\d{2}|655[0-2]\\\\d|6553[0-5])$\",\"msg\":\"请输入正确端口\"}');
...
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('algorithmSystem', '分析主机配置', 'algorithmResourceUrl', 'http://172.24.39.150:20014/algorithmResource', '算法资源接口', '巡视主机调用分析主机算法资源信息接口', '{\"rule\":\"^(http|https):\\\\/\\\\/[\\\\w\\\\-_]+(\\\\.[\\\\w\\\\-_]+)+([\\\\w\\\\-\\\\.,@?^=%&amp;:/~\\\\+#]*[\\\\w\\\\-\\\\@?^=%&amp;/~\\\\+#])?$\",\"msg\":\"请输入正确地址\"}');
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('algorithmSystem', '分析主机配置', 'systemCheckUrl', 'http://172.24.39.150:20014/systemCheck', '系统自检接口', '巡视主机调用分析主机系统自检信息接口', '{\"rule\":\"^(http|https):\\\\/\\\\/[\\\\w\\\\-_]+(\\\\.[\\\\w\\\\-_]+)+([\\\\w\\\\-\\\\.,@?^=%&amp;:/~\\\\+#]*[\\\\w\\\\-\\\\@?^=%&amp;/~\\\\+#])?$\",\"msg\":\"请输入正确地址\"}');
...
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('videoServerConfig', 'video服务的配置', 'ffmpeg-207', '/usr/local/bin/ffmpeg -rtsp_transport tcp -stimeout 30000000 -i rtsp://${username}:${password}@${ip}:${port}/Streaming/Channels/${channelId}01?transportmode=unicast -vcodec copy -fflags nobuffer -an -f flv rtmp://${hostIp}/live/${name}', '海康拉流命令', '无', NULL);
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('videoServerConfig', 'video服务的配置', 'ffmpeg-208', '/usr/local/bin/ffmpeg -rtsp_transport tcp -stimeout 30000000 -i rtsp://${username}:${password}@${ip}:${port}/cam/realmonitor?channel=${channelId}%26subtype=0 -vcodec copy -fflags nobuffer -an -f flv rtmp://${hostIp}/live/${name}', '大华拉流命令', '无', NULL);
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('videoServerConfig', 'video服务的配置', 'ffmpeg-209', '/usr/local/bin/ffmpeg -rtsp_transport tcp -stimeout 30000000 -i rtsp://${ip}:${port}/user=${username}\&password=${password}\&channel=${channelId}\&stream=0.sdp?real_stream -vcodec copy -fflags nobuffer -an -f flv rtmp://${hostIp}/live/${name}', '雄迈拉流命令', '无', NULL);
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('videoServerConfig', 'video服务的配置', 'ffmpeg-818', '/usr/local/bin/ffmpeg -rtsp_transport tcp -stimeout 30000000 -i rtsp://${ip}:${port}/camera0 -vcodec copy -fflags nobuffer -an -f flv rtmp://${hostIp}/live/${name}', '巨哥拉流命令', '无', NULL);
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('videoServerConfig', 'video服务的配置', 'ffmpeg-819', '/usr/local/bin/ffmpeg -rtsp_transport tcp -stimeout 30000000 -i rtsp://${ip}:${port}/video -vcodec copy -fflags nobuffer -an -f flv rtmp://${hostIp}/live/${name}', '高德拉流命令', '无', NULL);
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('videoServerConfig', 'video服务的配置', 'nvrRtmpBack', '/usr/local/bin/ffmpeg -rtsp_transport tcp -stimeout 30000000 -i rtsp://${username}:${password}@${ip}:${port}/Streaming/tracks/${channelId}01?starttime=${starttime}\&endtime=${endtime} -vcodec copy -fflags nobuffer -an -f flv rtmp://${hostIp}/live/${name}', '回放拉流命令', '无', NULL);
...
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('videoServerConfig', 'video服务的配置', 'mediaStreamPush', '/usr/local/bin/ffmpeg -i rtmp://${ip}:${port}/${app}/${stream} -vcodec copy -fflags nobuffer -an -f flv rtmp://${hostIp}/live/${name}', '机器人流媒体拉流', '从机器人的流媒体服务器取流', NULL);
...
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('audioConfig', '声纹相关配置', 'audioMqttHost', 'tcp://127.0.0.1:1883', 'mqtt地址', '声纹设备的mqtt地址配置 本机地址', '{\"rule\":\"^(tcp|ssl):\\\\/\\\\/[\\\\w\\\\-_]+(\\\\.[\\\\w\\\\-_]+)+([\\\\w\\\\-\\\\.,@?^=%&amp;:/~\\\\+#]*[\\\\w\\\\-\\\\@?^=%&amp;/~\\\\+#])?$\",\"msg\":\"请输入正确地址\"}');
