...
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES (''videoServerConfig'', ''video服务的配置'', ''ffmpegCmd'', ''ffmpeg.cmd'', ''ffmpeg拉流命令'', ''无'', NULL);
