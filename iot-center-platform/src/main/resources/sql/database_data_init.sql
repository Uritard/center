...
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('managerSystem', '算法管理平台配置', 'mqttHost', 'tcp://192.168.9.40:1883', 'mqtt地址', '算法管理平台mqtt服务地址', '{\"rule\":\"^(tcp|ssl):\\\\/\\\\/[\\\\w\\\\-_]+(\\\\.[\\\\w\\\\-_]+)+([\\\\w\\\\-\\\\.,@?^=%&amp;:/~\\\\+#]*[\\\\w\\\\-\\\\@?^=%&amp;/~\\\\+#])?$\",\"msg\":\"请输入正确地址\"}');
