...
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('managerSystem', '算法管理平台配置', 'stationId', 'Station01', '变电站编码', '消息内容基础配置', '{\"rule\":\"^[_a-zA-Z0-9\\\\-]+$\",\"msg\":\"请不要输入特殊字符\"}');
