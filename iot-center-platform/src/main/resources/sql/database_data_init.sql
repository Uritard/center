...
INSERT INTO `t_dict_business`(`dict_code`, `col_name`, `dict_note`, `up_dict`, `remark`, `sort`) VALUES ('690', 'mete_type', '局放地电压检测', NULL, '巡视内容', 8);
INSERT INTO `t_dict_business`(`dict_code`, `col_name`, `dict_note`, `up_dict`, `remark`, `sort`) VALUES ('691', 'mete_type', '局放超声波检测', NULL, '巡视内容', 7);
INSERT INTO `t_dict_business`(`dict_code`, `col_name`, `dict_note`, `up_dict`, `remark`, `sort`) VALUES ('692', 'mete_type', '局放特高频图谱', NULL, '巡视内容', 9);
...
INSERT INTO `t_dict_business`(`dict_code`, `col_name`, `dict_note`, `up_dict`, `remark`, `sort`) VALUES ('814', 'mete_type', '环境温度检测', '1', '巡视内容', '10');
INSERT INTO `t_dict_business`(`dict_code`, `col_name`, `dict_note`, `up_dict`, `remark`, `sort`) VALUES ('815', 'mete_type', '环境湿度检测', '1', '巡视内容', '11');
INSERT INTO `t_dict_business`(`dict_code`, `col_name`, `dict_note`, `up_dict`, `remark`, `sort`) VALUES ('816', 'mete_type', '氧气浓度检测', '1', '巡视内容', '12');
INSERT INTO `t_dict_business`(`dict_code`, `col_name`, `dict_note`, `up_dict`, `remark`, `sort`) VALUES ('817', 'mete_type', 'SF6浓度检测', '1', '巡视内容', '13');
...
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES ('videoServerConfig', 'video服务的配置', 'droneVideo', '/usr/local/bin/ffmpeg -rtsp_transport tcp -i rtsp://%s/live/%s -vcodec copy -fflags nobuffer -an -f flv rtmp://172.16.64.9/live/%s', '无人机拉流命令', '无', NULL);
