...
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES (''videoServerConfig'', ''video服务的配置'', ''ffmpegCmd'', ''%s -rtsp_transport tcp -stimeout 30000000 -i %s -vcodec copy -fflags nobuffer -an -f flv %s'', ''ffmpeg拉流命令'', ''无'', NULL);
...
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES (''videoServerConfig'', ''video服务的配置'', ''nvrRtmpBack'', ''rtsp://${username}:${password}@${ip}:${port}/Streaming/tracks/${channelId}01?starttime=${starttime}\&endtime=${endtime}'', ''回放拉流命令'', ''无'', NULL);
...
INSERT INTO `system_config` (`config_type`, `config_name`, `config_key`, `config_value`, `config_remark`, `remark`, `rules`) VALUES (''videoServerConfig'', ''video服务的配置'', ''droneVideo'', ''rtsp://%s:%s/live/%s'', ''无人机拉流命令'', ''无'', NULL);
